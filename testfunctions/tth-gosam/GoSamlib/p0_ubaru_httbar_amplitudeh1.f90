...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p0_ubaru_httbar_diagramsh1l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p0_ubaru_httbar_abbrevd1h1, only: init_abbrevd1 => init_abbrev
      use p0_ubaru_httbar_abbrevd13h1, only: init_abbrevd13 => init_abbrev
      use p0_ubaru_httbar_abbrevd43h1, only: init_abbrevd43 => init_abbrev
      use p0_ubaru_httbar_abbrevd58h1, only: init_abbrevd58 => init_abbrev
      use p0_ubaru_httbar_abbrevd3h1, only: init_abbrevd3 => init_abbrev
      use p0_ubaru_httbar_abbrevd59h1, only: init_abbrevd59 => init_abbrev
      use p0_ubaru_httbar_abbrevd64h1, only: init_abbrevd64 => init_abbrev
      use p0_ubaru_httbar_abbrevd67h1, only: init_abbrevd67 => init_abbrev
      use p0_ubaru_httbar_abbrevd84h1, only: init_abbrevd84 => init_abbrev
      use p0_ubaru_httbar_abbrevd2h1, only: init_abbrevd2 => init_abbrev
      use p0_ubaru_httbar_abbrevd4h1, only: init_abbrevd4 => init_abbrev
      use p0_ubaru_httbar_abbrevd21h1, only: init_abbrevd21 => init_abbrev
      use p0_ubaru_httbar_abbrevd22h1, only: init_abbrevd22 => init_abbrev
      use p0_ubaru_httbar_abbrevd39h1, only: init_abbrevd39 => init_abbrev
      use p0_ubaru_httbar_abbrevd57h1, only: init_abbrevd57 => init_abbrev
      use p0_ubaru_httbar_abbrevd65h1, only: init_abbrevd65 => init_abbrev
      use p0_ubaru_httbar_abbrevd66h1, only: init_abbrevd66 => init_abbrev
      use p0_ubaru_httbar_abbrevd71h1, only: init_abbrevd71 => init_abbrev
      use p0_ubaru_httbar_abbrevd72h1, only: init_abbrevd72 => init_abbrev
      use p0_ubaru_httbar_abbrevd77h1, only: init_abbrevd77 => init_abbrev
      use p0_ubaru_httbar_abbrevd83h1, only: init_abbrevd83 => init_abbrev
      use p0_ubaru_httbar_diagramsh1l0, only: amplitudel0 => amplitude
      use p0_ubaru_httbar_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p0_ubaru_httbar_ninjah1, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   use p0_ubaru_httbar_config, only: &
      & logfile, debug_nlo_diagrams
   use p0_ubaru_httbar_globalsl1, only: epspow
   use p0_ubaru_httbar_ninjah1, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   use p0_ubaru_httbar_config, only: &
      & logfile, debug_nlo_diagrams
   use p0_ubaru_httbar_globalsl1, only: epspow
   use p0_ubaru_httbar_ninjah1, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   use p0_ubaru_httbar_config, only: &
      & logfile, debug_nlo_diagrams
   use p0_ubaru_httbar_globalsl1, only: epspow
   use p0_ubaru_httbar_ninjah1, only: ninja_reduce => ninja_reduce_group3
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group3:
end module p0_ubaru_httbar_amplitudeh1

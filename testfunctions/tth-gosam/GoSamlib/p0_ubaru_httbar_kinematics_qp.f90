module     p0_ubaru_httbar_kinematics_qp
   use p0_ubaru_httbar_config, only: ki => ki_qp
   use p0_ubaru_httbar_model_qp
   use p0_ubaru_httbar_scalar_cache
   implicit none
   save
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs)
      use p0_ubaru_httbar_config, only: debug_numpolvec, logfile
      use p0_ubaru_httbar_model_qp
      implicit none
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p0_ubaru_httbar_kinematics_qp

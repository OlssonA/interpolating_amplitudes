module     p2_gg_httbar_d2h8l1d_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity8d2h8l1d_qp.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      acd2(2)=abb2(21)
      acd2(3)=dotproduct(qshift,spval3k2)
      acd2(4)=abb2(11)
      acd2(5)=dotproduct(qshift,spval4l3)
      acd2(6)=abb2(9)
      acd2(7)=dotproduct(qshift,spval4l5)
      acd2(8)=abb2(8)
...
!---#] function derivative:
end module     p2_gg_httbar_d2h8l1d_qp

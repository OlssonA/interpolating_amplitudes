module     p2_gg_httbar_d162h12l131_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d162h12l131_qp.f90
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd162(3)=abb162(12)
      acd162(4)=dotproduct(ninjaE3,spvae1l5)
      acd162(5)=dotproduct(ninjaE4,spval5e1)
      acd162(6)=dotproduct(ninjaE4,spvak2e1)
      acd162(7)=abb162(28)
      acd162(8)=dotproduct(ninjaE4,spvak1e1)
      acd162(9)=abb162(14)
      acd162(10)=dotproduct(ninjaE4,spval4e1)
      acd162(11)=abb162(20)
      acd162(12)=dotproduct(ninjaE4,spvae2e1)
      acd162(13)=abb162(40)
      acd162(14)=dotproduct(ninjaE3,spvak2e1)
      acd162(15)=dotproduct(ninjaE4,spvae1k2)
      acd162(16)=abb162(19)
      acd162(17)=dotproduct(ninjaE4,spvae1k1)
      acd162(18)=abb162(44)
      acd162(19)=dotproduct(ninjaE4,spvae1e2)
      acd162(20)=abb162(26)
      acd162(21)=dotproduct(ninjaE4,spvae1l4)
      acd162(22)=abb162(29)
      acd162(23)=dotproduct(ninjaE3,spvak1e1)
      acd162(24)=dotproduct(ninjaE3,spvae1k2)
      acd162(25)=dotproduct(ninjaE3,spval4e1)
      acd162(26)=dotproduct(ninjaE3,spvae2e1)
      acd162(27)=dotproduct(ninjaE3,spvae1k1)
      acd162(28)=dotproduct(ninjaE3,spvae1e2)
      acd162(29)=dotproduct(ninjaE3,spvae1l4)
      acd162(30)=dotproduct(ninjaA,spval5e1)
      acd162(31)=dotproduct(ninjaA,spvae1l5)
      acd162(32)=dotproduct(ninjaA,spvak2e1)
      acd162(33)=dotproduct(ninjaA,spvak1e1)
      acd162(34)=dotproduct(ninjaA,spvae1k2)
      acd162(35)=dotproduct(ninjaA,spval4e1)
      acd162(36)=dotproduct(ninjaA,spvae2e1)
      acd162(37)=dotproduct(ninjaA,spvae1k1)
      acd162(38)=dotproduct(ninjaA,spvae1e2)
      acd162(39)=dotproduct(ninjaA,spvae1l4)
      acd162(40)=abb162(47)
      acd162(41)=abb162(15)
      acd162(42)=abb162(13)
      acd162(43)=abb162(24)
      ...
      acd162(53)=acd162(13)*acd162(26)
      acd162(54)=acd162(11)*acd162(25)
      acd162(55)=acd162(9)*acd162(23)
      ...
      acd162(52)=acd162(13)*acd162(36)
      acd162(54)=acd162(11)*acd162(35)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_gg_httbar_d162h12_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_gg_httbar_d162h12l131_qp

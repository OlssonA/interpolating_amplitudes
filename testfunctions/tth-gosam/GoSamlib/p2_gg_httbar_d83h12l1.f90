module     p2_gg_httbar_d83h12l1
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d83h12l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p2_gg_httbar_d83h12l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p2_gg_httbar_d83h12l1

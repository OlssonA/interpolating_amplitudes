module     p0_ubaru_httbar_diagramsh1l0_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity1diagramsl0_qp.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(4)=NC**(-1)
      abb(5)=spak1l4*abb(1)*spal3l5
      abb(6)=spak1l5*abb(3)*spal3l4
      abb(5)=abb(5)+abb(6)
      abb(6)=e*spbl3k2*TR*i_*gs**2*abb(2)*gHT
      abb(6)=2.0_ki*abb(6)
      abb(5)=abb(6)*abb(5)
      abb(6)=abb(4)*abb(5)
...
!---#] function amplitude:
end module p0_ubaru_httbar_diagramsh1l0_qp

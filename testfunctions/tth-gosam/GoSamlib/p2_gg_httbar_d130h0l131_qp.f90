module     p2_gg_httbar_d130h0l131_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity0d130h0l131_qp.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_gg_httbar_abbrevd130h0_qp
      implicit none
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd130(9)=dotproduct(ninjaE3,spval3k2)
      acd130(10)=abb130(13)
      acd130(11)=dotproduct(ninjaE3,spval4k2)
      acd130(12)=abb130(14)
      acd130(13)=dotproduct(ninjaE3,spval4k1)
      acd130(14)=abb130(15)
      acd130(15)=dotproduct(ninjaE3,spval3l4)
      acd130(16)=abb130(16)
      acd130(17)=dotproduct(ninjaE3,spval3k1)
      acd130(18)=abb130(17)
      acd130(19)=dotproduct(ninjaE3,spvak2l3)
      acd130(20)=abb130(19)
      acd130(21)=dotproduct(ninjaE3,spvak1l3)
      acd130(22)=abb130(20)
      acd130(23)=dotproduct(ninjaE3,spvak1k2)
      acd130(24)=abb130(24)
      acd130(25)=dotproduct(ninjaE3,spval4e1)
      acd130(26)=abb130(26)
      acd130(27)=dotproduct(ninjaE3,spvae1k2)
      acd130(28)=abb130(27)
      acd130(29)=dotproduct(ninjaE3,spval4e2)
      acd130(30)=abb130(40)
      acd130(31)=dotproduct(ninjaE3,spvae2k2)
      acd130(32)=abb130(44)
      acd130(33)=dotproduct(ninjaE3,spval4l3)
      acd130(34)=abb130(48)
      acd130(35)=dotproduct(ninjaE3,spval3e2)
      acd130(36)=abb130(59)
      acd130(37)=dotproduct(ninjaE3,spvae2l3)
      acd130(38)=abb130(67)
      acd130(39)=dotproduct(ninjaE3,spval3e1)
      acd130(40)=abb130(68)
      acd130(41)=dotproduct(ninjaE3,spvae1l3)
      ...
      acd130(47)=dotproduct(ninjaA,spval3k2)
      acd130(48)=dotproduct(ninjaA,spval4k2)
      acd130(49)=dotproduct(ninjaA,spval4k1)
      acd130(50)=dotproduct(ninjaA,spval3l4)
      acd130(51)=dotproduct(ninjaA,spval3k1)
      acd130(52)=dotproduct(ninjaA,spvak2l3)
      acd130(53)=dotproduct(ninjaA,spvak1l3)
      acd130(54)=dotproduct(ninjaA,spvak1k2)
      acd130(55)=dotproduct(ninjaA,spval4e1)
      acd130(56)=dotproduct(ninjaA,spvae1k2)
      acd130(57)=dotproduct(ninjaA,spval4e2)
      acd130(58)=dotproduct(ninjaA,spvae2k2)
      acd130(59)=dotproduct(ninjaA,spval4l3)
      acd130(60)=dotproduct(ninjaA,spval3e2)
      acd130(61)=dotproduct(ninjaA,spvae2l3)
      acd130(62)=dotproduct(ninjaA,spval3e1)
      acd130(63)=dotproduct(ninjaA,spvae1l3)
      acd130(64)=abb130(18)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_gg_httbar_d130h0_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_gg_httbar_d130h0l131_qp

module     p0_ubaru_httbar_matrix
   use p0_ubaru_httbar_util, only: square
   use p0_ubaru_httbar_util_qp, only: square_qp => square
   ...
   use p0_ubaru_httbar_kinematics, only: &
       in_helicities, symmetry_factor, num_legs, &
       lo_qcd_couplings, corrections_are_qcd, num_light_quarks, num_gluons
   use p0_ubaru_httbar_model, only: Nf, NC, sqrt2, init_functions
   use p0_ubaru_httbar_model_qp, only: Nf_qp => Nf, NC_qp => NC, sqrt2_qp => sqrt2, &
     & init_functions_qp => init_functions
   use p0_ubaru_httbar_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p0_ubaru_httbar_color_qp, only: TR_qp => TR, CA_qp => CA, CF_qp => CF, &
     & incolors_qp => incolors, init_color_qp => init_color
   use p0_ubaru_httbar_diagramsh0l0, only: amplitude0l0 => amplitude
   use p0_ubaru_httbar_diagramsh0l0_qp, only: amplitude0l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh0, only: samplitudeh0l1 => samplitude, &
     &   finite_renormalisation0 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh0_qp, only: samplitudeh0l1_qp => samplitude, &
     &   finite_renormalisation0_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh1l0, only: amplitude1l0 => amplitude
   use p0_ubaru_httbar_diagramsh1l0_qp, only: amplitude1l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh1, only: samplitudeh1l1 => samplitude, &
     &   finite_renormalisation1 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh1_qp, only: samplitudeh1l1_qp => samplitude, &
     &   finite_renormalisation1_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh2l0, only: amplitude2l0 => amplitude
   use p0_ubaru_httbar_diagramsh2l0_qp, only: amplitude2l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh2, only: samplitudeh2l1 => samplitude, &
     &   finite_renormalisation2 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh2_qp, only: samplitudeh2l1_qp => samplitude, &
     &   finite_renormalisation2_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh3l0, only: amplitude3l0 => amplitude
   use p0_ubaru_httbar_diagramsh3l0_qp, only: amplitude3l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh3, only: samplitudeh3l1 => samplitude, &
     &   finite_renormalisation3 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh3_qp, only: samplitudeh3l1_qp => samplitude, &
     &   finite_renormalisation3_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh4l0, only: amplitude4l0 => amplitude
   use p0_ubaru_httbar_diagramsh4l0_qp, only: amplitude4l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh4, only: samplitudeh4l1 => samplitude, &
     &   finite_renormalisation4 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh4_qp, only: samplitudeh4l1_qp => samplitude, &
     &   finite_renormalisation4_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh5l0, only: amplitude5l0 => amplitude
   use p0_ubaru_httbar_diagramsh5l0_qp, only: amplitude5l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh5, only: samplitudeh5l1 => samplitude, &
     &   finite_renormalisation5 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh5_qp, only: samplitudeh5l1_qp => samplitude, &
     &   finite_renormalisation5_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh6l0, only: amplitude6l0 => amplitude
   use p0_ubaru_httbar_diagramsh6l0_qp, only: amplitude6l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh6, only: samplitudeh6l1 => samplitude, &
     &   finite_renormalisation6 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh6_qp, only: samplitudeh6l1_qp => samplitude, &
     &   finite_renormalisation6_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh7l0, only: amplitude7l0 => amplitude
   use p0_ubaru_httbar_diagramsh7l0_qp, only: amplitude7l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh7, only: samplitudeh7l1 => samplitude, &
     &   finite_renormalisation7 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh7_qp, only: samplitudeh7l1_qp => samplitude, &
     &   finite_renormalisation7_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh8l0, only: amplitude8l0 => amplitude
   use p0_ubaru_httbar_diagramsh8l0_qp, only: amplitude8l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh8, only: samplitudeh8l1 => samplitude, &
     &   finite_renormalisation8 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh8_qp, only: samplitudeh8l1_qp => samplitude, &
     &   finite_renormalisation8_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh9l0, only: amplitude9l0 => amplitude
   use p0_ubaru_httbar_diagramsh9l0_qp, only: amplitude9l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh9, only: samplitudeh9l1 => samplitude, &
     &   finite_renormalisation9 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh9_qp, only: samplitudeh9l1_qp => samplitude, &
     &   finite_renormalisation9_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh10l0, only: amplitude10l0 => amplitude
   use p0_ubaru_httbar_diagramsh10l0_qp, only: amplitude10l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh10, only: samplitudeh10l1 => samplitude, &
     &   finite_renormalisation10 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh10_qp, only: samplitudeh10l1_qp => samplitude, &
     &   finite_renormalisation10_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh11l0, only: amplitude11l0 => amplitude
   use p0_ubaru_httbar_diagramsh11l0_qp, only: amplitude11l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh11, only: samplitudeh11l1 => samplitude, &
     &   finite_renormalisation11 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh11_qp, only: samplitudeh11l1_qp => samplitude, &
     &   finite_renormalisation11_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh12l0, only: amplitude12l0 => amplitude
   use p0_ubaru_httbar_diagramsh12l0_qp, only: amplitude12l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh12, only: samplitudeh12l1 => samplitude, &
     &   finite_renormalisation12 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh12_qp, only: samplitudeh12l1_qp => samplitude, &
     &   finite_renormalisation12_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh13l0, only: amplitude13l0 => amplitude
   use p0_ubaru_httbar_diagramsh13l0_qp, only: amplitude13l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh13, only: samplitudeh13l1 => samplitude, &
     &   finite_renormalisation13 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh13_qp, only: samplitudeh13l1_qp => samplitude, &
     &   finite_renormalisation13_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh14l0, only: amplitude14l0 => amplitude
   use p0_ubaru_httbar_diagramsh14l0_qp, only: amplitude14l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh14, only: samplitudeh14l1 => samplitude, &
     &   finite_renormalisation14 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh14_qp, only: samplitudeh14l1_qp => samplitude, &
     &   finite_renormalisation14_qp => finite_renormalisation
   use p0_ubaru_httbar_diagramsh15l0, only: amplitude15l0 => amplitude
   use p0_ubaru_httbar_diagramsh15l0_qp, only: amplitude15l0_qp => amplitude
   use p0_ubaru_httbar_amplitudeh15, only: samplitudeh15l1 => samplitude, &
     &   finite_renormalisation15 => finite_renormalisation
   use p0_ubaru_httbar_amplitudeh15_qp, only: samplitudeh15l1_qp => samplitude, &
     &   finite_renormalisation15_qp => finite_renormalisation
   use p0_ubaru_httbar_dipoles, only: insertion_operator, insertion_operator_qed
   use p0_ubaru_httbar_dipoles_qp, only: insertion_operator_qp => insertion_operator, &
...
contains
   ...
   subroutine     banner()
      ...
      write(banner_ch,'(A74)') "|  \__/ \__/ (___/(_)(_)(_/\/\_)        Version 2.1.1 Rev: 33a38ce       |"
      write(banner_ch,'(A74)') "|                                                                        |"
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, fpprec, spprec, numprec, ok, h)
      use p0_ubaru_httbar_kinematics, only: adjust_kinematics
      use p0_ubaru_httbar_kinematics_qp, only: adjust_kinematics_qp => adjust_kinematics
      use p0_ubaru_httbar_model
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
      real(ki_qp), dimension(5, 4) :: vecs_qp, vecsrot_qp
      real(ki), dimension(5, 4) :: vecsrot
      real(ki), intent(in) :: scale2
      real(ki), dimension(1:5), intent(out) :: amp
      real(ki_qp), dimension(1:5) :: amp_qp
      real(ki_qp), dimension(2:3) :: irp_qp
      real(ki_qp) :: scale2_qp, rat2_qp
      real(ki), dimension(0:3) :: scales2
      real(ki), dimension(1:5) :: ampdef, amprot, ampres, ampresrot
      real(ki) :: rat2, kfac, zero, angle
      real(ki), dimension(2:3) :: irp
      integer, intent(out) :: prec 
      integer, intent(out), optional :: fpprec, spprec, numprec
     ...
     &              mT/)
      ...
      if(PSP_check) then
         ...
         fpprec=fpprec1
         ! icheck=3
         if(prec.lt.PSP_chk_th1) then                                       ! RESCUE
            icheck=3
         endif
         ...
         if(icheck.eq.3.and.PSP_rescue) then
            ...
            vecs_qp = vecs
            ! call refine_momenta_to_qp(5,vecs,vecs_qp,3+1,scales2)
            ...
            if(spprec2.gt.PSP_chk_th1.and. &
                 (kfac.lt.PSP_chk_kfactor.or.PSP_chk_kfactor.lt.0)) icheck=2      ! ACCEPT
            ...
            ! endif
            if(spprec2.lt.PSP_chk_th1.or. &
            (kfac.gt.PSP_chk_kfactor.and.PSP_chk_kfactor.gt.0)) icheck=2 ! ROTATION
            if(icheck.eq.2) then
               do irot = 1,5
                  ! vecsrot(irot,1) = vecs(irot,1)
                  ! vecsrot(irot,2) = vecs(irot,2)*Cos(angle)-vecs(irot,3)*Sin(angle)
                  ...
                  vecsrot_qp(irot,2) = vecs_qp(irot,2)*Cos(real(angle,ki_qp))-vecs_qp(irot,3)*Sin(real(angle,ki_qp))
                  vecsrot_qp(irot,3) = vecs_qp(irot,2)*Sin(real(angle,ki_qp))+vecs_qp(irot,3)*Cos(real(angle,ki_qp))
         ...
         if(icheck.eq.3.and.PSP_verbosity) then
            ...
            write(42,'(4x,A15,A5,A3)') &
                 &  "<process name='","p0_ubaru_httbar","'/>"
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use p0_ubaru_httbar_model
      use p0_ubaru_httbar_dipoles, only: pi
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      real(ki), dimension(5), intent(out) :: amp
      ...
      if (present(h)) then
         amp((/1,5/)) = samplitudel0(vecs, h)
      else
         amp((/1,5/))   = samplitudel0(vecs)
      end if
      ...
      case default
         ! not implemented
         print*, "In p0_ubaru_httbar_matrix:"
         ...
         if(corrections_are_qcd) then
            ...
            ! Renormalization of Yukawa coupling
               if (mT > 0.0_ki) then  
                   ...
                   if (renorm_logs) then
                      amp(2) = amp(2) &
                     &   - (1.5_ki*log(scale2/mT/mT)) * CF * amp(1)
                   end if
                   amp(3) = amp(3) -1.5_ki * CF * amp(1)
                   amp(2) = amp(2) -2.5_ki * CF * amp(1)
                   if (renorm_logs) then
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p0_ubaru_httbar_config, only: logfile
      use p0_ubaru_httbar_kinematics, only: init_event
      use p0_ubaru_httbar_color, only: T4T5
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
      integer, optional, intent(in) :: h
      real(ki), dimension(2) :: amp
      real(ki) heli_amp
      ...
      if (eval_heli(0)) then
         ...
         amp(1) = amp(1) + heli_amp
         amp(2) = amp(2) + square(color_vector, T4T5)
      end if
      if (eval_heli(1)) then
         if (debug_lo_diagrams) then
      ...
      if (eval_heli(8)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='8' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(9)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='9' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(10)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='10' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(11)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='11' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(12)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='12' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(13)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='13' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(14)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='14' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(15)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='15' >"
         end if
         !---#[ reinitialize kinematics:
         pvecs(1,:) = vecs(1,:)
         pvecs(2,:) = vecs(2,:)
   ...
   function     samplitudel1(vecs,scale2,ok,rat2,h) result(amp)
      ...
      if (eval_heli(8)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh8l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation8(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(9)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh9l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation9(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(10)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh10l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation10(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(11)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh11l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation11(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(12)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh12l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation12(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(13)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh13l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation13(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(14)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh14l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation14(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(15)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh15l1(real(scale2,ki),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation15(real(scale2,ki))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
   ...
   subroutine     samplitudel01_qp(vecs, scale2, amp, rat2, ok, h)
      ...
      use p0_ubaru_httbar_dipoles_qp, only: pi
      implicit none
      ...
      ! Number of heavy quark flavours in loops.
      real(ki_qp), parameter :: NFh_qp = 1.0_ki_qp
      ...
      if (present(h)) then
         amp((/1,5/)) = samplitudel0_qp(vecs, h)
      else
         amp((/1,5/)) = samplitudel0_qp(vecs)
      end if
      select case (renormalisation)
      case (0)
         ! no renormalisation
      ...
      case (1)
         ...
         if(corrections_are_qcd) then
            ...
            if (renorm_yukawa) then
            ! Renormalization of Yukawa coupling
               if (mT > 0.0_ki_qp) then  
                  amp(3) = amp(3) -1.5_ki_qp * CF_qp * amp(1)
                  amp(2) = amp(2) -2.5_ki_qp * CF_qp * amp(1)
                  if (renorm_logs) then
                     amp(2) = amp(2) &
                    &   - (1.5_ki_qp*log(scale2/mT/mT)) * CF_qp * amp(1)
                  end if
                  amp(3) = amp(3) -1.5_ki_qp * CF_qp * amp(1)
                  amp(2) = amp(2) -2.5_ki_qp * CF_qp * amp(1)
                  if (renorm_logs) then
   ...
   function     samplitudel0_qp(vecs, h) result(amp)
      use p0_ubaru_httbar_config, only: logfile
      use p0_ubaru_httbar_kinematics_qp, only: init_event
      use p0_ubaru_httbar_color_qp, only: T4T5
      implicit none
      real(ki_qp), dimension(5, 4), intent(in) :: vecs
      integer, optional, intent(in) :: h
      real(ki_qp), dimension(2) :: amp
      real(ki_qp) heli_amp
      ...
      if (eval_heli(0)) then
         ...
         amp(1) = amp(1) + heli_amp
         amp(2) = amp(2) + square_qp(color_vector, T4T5)
      end if
      if (eval_heli(1)) then
         if (debug_lo_diagrams) then
            write(logfile,*) "<helicity index='1' >"
   ...
   function     samplitudel1_qp(vecs,scale2,ok,rat2,h) result(amp)
      ...
      if (eval_heli(0)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh0l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(1)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh1l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(2)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh2l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(3)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh3l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(4)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh4l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
      ...
      if (eval_heli(5)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh5l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation5_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(6)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh6l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation6_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(7)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh7l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation7_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(8)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh8l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation8_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(9)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh9l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation9_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(10)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh10l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation10_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(11)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh11l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation11_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(12)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh12l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation12_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(13)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh13l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation13_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(14)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh14l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation14_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
      ...
      if (eval_heli(15)) then
         ...
         call init_event(pvecs)
         !---#] reinitialize kinematics:
         heli_amp = samplitudeh15l1_qp(real(scale2,ki_qp),my_ok,rational2)
         if (corrections_are_qcd .and. renorm_gamma5) then
            !---#[ reinitialize kinematics:
            pvecs(1,:) = vecs(1,:)
            pvecs(2,:) = vecs(2,:)
            ...
            call init_event(pvecs)
            !---#] reinitialize kinematics:
            fr = finite_renormalisation15_qp(real(scale2,ki_qp))
            heli_amp(0) = heli_amp(0) + fr
         end if
         ok = ok .and. my_ok
         amp = amp + heli_amp
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use p0_ubaru_httbar_color, only: T1T1, &
      & T1T2, &
      & T1T4, &
      & T1T5, &
      & T2T2, &
      ...
      res(2,1) = res(1,2)
      res(1,4) = square(color_vector,T1T4)
      res(4,1) = res(1,4)
      res(1,5) = square(color_vector,T1T5)
      res(5,1) = res(1,5)
      res(2,2) = square(color_vector,T2T2)
      res(2,2) = res(2,2)
      res(2,4) = square(color_vector,T2T4)
      res(4,2) = res(2,4)
      res(2,5) = square(color_vector,T2T5)
      res(5,2) = res(2,5)
      res(4,4) = square(color_vector,T4T4)
      res(4,4) = res(4,4)
      res(4,5) = square(color_vector,T4T5)
      res(5,4) = res(4,5)
   ...
   pure subroutine OLP_color_correlated_lo(color_vector,res)
      ...
      res(4) = square(color_vector,T1T4)  
      res(7) = square(color_vector,T1T5)    
      res(5) = square(color_vector,T2T4)  
      res(8) = square(color_vector,T2T5)    
      res(10) = square(color_vector,T4T5)   
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use p0_ubaru_httbar_color, only: cmat => CC
      implicit none
...
end module p0_ubaru_httbar_matrix

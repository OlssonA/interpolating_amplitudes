module     p2_gg_httbar_abbrevd113h8_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb113(5)=spak2l3**(-1)
      abb113(6)=spbl3k2**(-1)
      abb113(7)=spbl5e1*spak2l4
      abb113(8)=spbk2e2*spae1e2
      abb113(9)=-abb113(7)*abb113(8)
      abb113(10)=spae1l4*spbl5k2
      abb113(11)=spae2k2*spbe2e1
      ...
      abb113(31)=abb113(14)*spbk1e1
      abb113(32)=abb113(31)*spak1l4
      abb113(33)=abb113(32)*spbl5l3
      abb113(34)=-spak2l3*abb113(8)*abb113(33)
      abb113(35)=abb113(14)*spae1k1
      abb113(36)=abb113(35)*spbl5k1
      abb113(37)=abb113(36)*spal3l4
      abb113(38)=-spbl3k2*abb113(11)*abb113(37)
      abb113(39)=spal3l4*spbl5e1
      ...
      abb113(41)=abb113(40)*spbl5e2
      abb113(42)=spak1l4*spbk1e1*abb113(41)
      abb113(43)=abb113(28)*spae2l4
      abb113(44)=spbl5k1*spae1k1*abb113(43)
      abb113(9)=abb113(29)+abb113(16)+abb113(44)+abb113(42)+abb113(26)+abb113(2&
      &3)+abb113(38)+abb113(34)+abb113(9)
      abb113(16)=abb113(17)*abb113(8)
      abb113(23)=abb113(16)*abb113(25)
      abb113(26)=abb113(17)*abb113(11)
      abb113(29)=abb113(26)*abb113(22)
      abb113(23)=abb113(23)+abb113(29)
      abb113(29)=-2.0_ki*abb113(23)
      abb113(34)=-spbl5e2*spae1e2*abb113(32)
      abb113(38)=-spae2l4*spbe2e1*abb113(36)
      abb113(23)=abb113(38)+abb113(34)+abb113(23)
      abb113(34)=abb113(35)*spbl5k1*spak2l4
      abb113(35)=-abb113(13)*abb113(34)
      abb113(38)=abb113(14)*spak2l3
      abb113(27)=-abb113(38)*abb113(27)
      abb113(27)=abb113(35)+abb113(27)
      abb113(27)=spbk2e2*abb113(27)
      abb113(35)=spae1k2*spbk2e2
      abb113(42)=-abb113(19)*abb113(35)
      abb113(44)=abb113(22)*abb113(18)
      abb113(37)=abb113(44)+abb113(37)
      abb113(44)=-spbl3e2*abb113(37)
      abb113(45)=spbl5e2*spae1l4*abb113(15)
      abb113(27)=abb113(44)+abb113(45)+abb113(42)+abb113(27)
      abb113(42)=2.0_ki*abb113(17)
      abb113(44)=-abb113(42)*abb113(35)
      abb113(35)=abb113(17)*abb113(35)
      abb113(45)=abb113(14)*spae1l4
      abb113(46)=-spbl5e2*abb113(45)
      abb113(35)=abb113(35)+abb113(46)
      abb113(31)=abb113(31)*spak1l4*spbl5k2
      abb113(13)=-abb113(13)*abb113(31)
      ...
      abb113(33)=abb113(48)+abb113(33)
      abb113(48)=-spae2l3*abb113(33)
      abb113(15)=spae2l4*spbl5e1*abb113(15)
      abb113(13)=abb113(48)+abb113(15)+abb113(19)+abb113(13)
      abb113(15)=-abb113(42)*abb113(39)
      abb113(17)=abb113(17)*abb113(39)
      abb113(19)=abb113(14)*spbl5e1
      abb113(39)=-spae2l4*abb113(19)
      abb113(17)=abb113(17)+abb113(39)
      abb113(28)=2.0_ki*spae1l4*abb113(28)
      abb113(39)=2.0_ki*abb113(32)
      abb113(46)=spal3l4*abb113(11)*abb113(46)
      abb113(43)=abb113(46)-abb113(43)
      abb113(46)=abb113(14)*spbe2e1
      abb113(48)=spae2l4*abb113(46)
      abb113(49)=abb113(12)*abb113(14)
      abb113(50)=2.0_ki*abb113(14)
      abb113(51)=abb113(49)-abb113(50)
      abb113(52)=spak2l4*spbk2e2*abb113(51)
      abb113(53)=spbl3e2*spal3l4*abb113(14)
      abb113(52)=abb113(52)+abb113(53)
      abb113(40)=2.0_ki*spbl5e1*abb113(40)
      abb113(53)=2.0_ki*abb113(36)
      abb113(38)=spbl5l3*abb113(8)*abb113(38)
      abb113(38)=abb113(38)-abb113(41)
      abb113(41)=abb113(14)*spae1e2
      abb113(54)=spbl5e2*abb113(41)
      abb113(51)=spbl5k2*spae2k2*abb113(51)
      abb113(55)=spae2l3*spbl5l3*abb113(14)
      abb113(51)=abb113(51)+abb113(55)
      abb113(37)=-spbe2e1*abb113(37)
      abb113(55)=-spbk2e1*abb113(18)
      abb113(56)=-spal3l4*abb113(19)
      abb113(55)=abb113(56)+abb113(55)
      abb113(56)=spal3l4*abb113(46)
      abb113(33)=-spae1e2*abb113(33)
      abb113(57)=-spae1k2*abb113(47)
      abb113(58)=-spbl5l3*abb113(45)
      abb113(57)=abb113(58)+abb113(57)
      abb113(58)=spbl5l3*abb113(41)
      abb113(12)=abb113(12)-1.0_ki
      abb113(34)=-spbe2e1*abb113(12)*abb113(34)
      abb113(30)=abb113(34)-2.0_ki*abb113(30)
      abb113(34)=abb113(49)-abb113(14)
      abb113(7)=-abb113(34)*abb113(7)
      abb113(25)=-abb113(42)*abb113(25)
      abb113(7)=abb113(7)+abb113(25)
      abb113(25)=spbe2e1*abb113(49)
      abb113(25)=-abb113(46)+abb113(25)
      abb113(25)=spak2l4*abb113(25)
      abb113(12)=-abb113(12)*abb113(31)
      abb113(20)=spbk2e1*abb113(20)
      abb113(12)=abb113(12)-2.0_ki*abb113(20)
      abb113(12)=spae1e2*abb113(12)
      abb113(10)=-abb113(34)*abb113(10)
      abb113(20)=-abb113(42)*abb113(22)
      abb113(10)=abb113(10)+abb113(20)
      abb113(20)=spae1e2*abb113(49)
      abb113(20)=-abb113(41)+abb113(20)
      abb113(20)=spbl5k2*abb113(20)
      abb113(22)=abb113(11)*abb113(42)
      abb113(31)=spbl3e2*abb113(18)
      abb113(18)=spbe2e1*abb113(18)
      abb113(34)=abb113(8)*abb113(42)
      abb113(41)=spae2l3*abb113(47)
...
end module p2_gg_httbar_abbrevd113h8_qp

module     p2_gg_httbar_color_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSam_POWHEG/Virtual/p2_gg_httbar/common/color.f90 
   ! generator: buildcolor.py
   use p2_gg_httbar_config, only: ki => ki_qp
   use p2_gg_httbar_model_qp, only: NC, Nf
   implicit none
   private
   save
   ...
   real(ki) :: NA
   real(ki), dimension(20) :: cabb

   ! Basis vectors
   real(ki), dimension(numcs), parameter, public :: c1 = &
      & (/         1.0_ki         , 0.0_ki, 0.0_ki/)
   real(ki), dimension(numcs), parameter, public :: c2 = &
      & (/         0.0_ki,          1.0_ki         , 0.0_ki/)
   real(ki), dimension(numcs), parameter, public :: c3 = &
      & (/         0.0_ki, 0.0_ki,          1.0_ki/)
contains
   subroutine     init_color()
      ...
      cabb(1)=NC**(-1)
      cabb(2)=NC**2
      cabb(3)=cabb(2)-2.0_ki
      cabb(4)=cabb(3)*NC
      cabb(4)=cabb(4)+cabb(1)
      cabb(5)=TR**2
      cabb(6)=cabb(4)*cabb(5)
      cabb(7)=NC-cabb(1)
      cabb(7)=cabb(7)*cabb(5)
      cabb(8)=cabb(2)-1.0_ki
      cabb(9)=cabb(8)*cabb(5)
      cabb(10)=NC*cabb(9)
      cabb(11)=cabb(3)*cabb(2)
      cabb(11)=cabb(11)+1.0_ki
      cabb(5)=cabb(11)*cabb(5)
      cabb(12)=cabb(9)*cabb(2)
      cabb(13)=TR**3
      cabb(8)=cabb(8)*cabb(13)
      cabb(14)=cabb(2)*cabb(8)
      cabb(15)=2.0_ki*NC
      cabb(15)=cabb(15)*cabb(8)
      cabb(16)=-2.0_ki*cabb(14)
      cabb(11)=cabb(11)*cabb(13)
      cabb(17)=NC*cabb(8)
      cabb(18)=cabb(2)-3.0_ki
      cabb(18)=cabb(18)*cabb(2)
      cabb(19)=cabb(1)**2
      cabb(18)=cabb(18)-cabb(19)+3.0_ki
      cabb(18)=cabb(18)*cabb(13)
      cabb(3)=cabb(3)+cabb(19)
      cabb(3)=cabb(3)*cabb(13)
      cabb(4)=cabb(4)*cabb(13)
      cabb(20)=cabb(19)-1.0_ki
      cabb(20)=cabb(20)*cabb(13)
      cabb(2)=cabb(19)-cabb(2)
      cabb(2)=cabb(2)*cabb(13)
      T1T1(1,1)=cabb(5)
      T1T1(1,2)=-cabb(9)
      T1T1(2,1)=-cabb(9)
      T1T1(1,3)=cabb(10)
...
end module p2_gg_httbar_color_qp

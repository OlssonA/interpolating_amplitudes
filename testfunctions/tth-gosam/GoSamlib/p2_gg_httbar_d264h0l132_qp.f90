module     p2_gg_httbar_d264h0l132_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity0d264h0l132_qp.f90
...
!---#[ subroutine brack_21:
   pure subroutine brack_21(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_gg_httbar_abbrevd264h0_qp
      implicit none
...
!---#[ subroutine brack_22:
   pure subroutine brack_22(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd264(2)=dotproduct(ninjaE3,spvae2k2)
      acd264(3)=dotproduct(ninjaE3,spvae1e2)
      acd264(4)=abb264(58)
      acd264(5)=dotproduct(l4,ninjaE3)
      acd264(6)=dotproduct(e1,ninjaE3)
      acd264(7)=dotproduct(ninjaE3,spval4e2)
      acd264(8)=abb264(46)
      acd264(9)=dotproduct(ninjaE3,spvae2e1)
      acd264(10)=abb264(20)
      acd264(11)=dotproduct(ninjaA0,ninjaE3)
      acd264(12)=abb264(79)
      acd264(13)=dotproduct(ninjaE3,spval5e2)
      acd264(14)=abb264(160)
      acd264(15)=abb264(14)
      acd264(16)=abb264(115)
      acd264(17)=dotproduct(ninjaE3,spval5l4)
      acd264(18)=dotproduct(ninjaE3,spval5k2)
      acd264(19)=dotproduct(ninjaE3,spvak2e2)
      acd264(20)=abb264(59)
      acd264(21)=dotproduct(ninjaE3,spval4k2)
      acd264(22)=abb264(89)
      acd264(23)=abb264(149)
      acd264(24)=abb264(110)
      acd264(25)=abb264(94)
      acd264(26)=dotproduct(ninjaE3,spvae2l4)
...
!---#[ subroutine numerator_t2:
   ...
   & bind(c, name="p2_gg_httbar_d264h0_qp_ninja_t2")
...
!---#] subroutine numerator_t2:
end module     p2_gg_httbar_d264h0l132_qp

module     p2_gg_httbar_d172h0l132_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity0d172h0l132_qp.f90
...
!---#[ subroutine brack_22:
   pure subroutine brack_22(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd172(2)=dotproduct(ninjaE3,spvae1k2)
      acd172(3)=abb172(15)
      acd172(4)=dotproduct(ninjaA1,spvae1k2)
      acd172(5)=dotproduct(ninjaE3,spvak2e1)
      acd172(6)=dotproduct(ninjaE3,spvae2e1)
      acd172(7)=abb172(29)
      acd172(8)=dotproduct(ninjaE3,spval4e1)
      acd172(9)=abb172(26)
      acd172(10)=dotproduct(ninjaE3,spval5e1)
      acd172(11)=abb172(30)
      acd172(12)=dotproduct(ninjaA1,spvae2e1)
      acd172(13)=dotproduct(ninjaE3,spvae1e2)
      acd172(14)=abb172(54)
      acd172(15)=dotproduct(ninjaA1,spval4e1)
      acd172(16)=abb172(23)
      acd172(17)=dotproduct(ninjaE3,spvae1l5)
      acd172(18)=abb172(24)
      acd172(19)=dotproduct(ninjaE3,spvae1l4)
      acd172(20)=abb172(66)
      acd172(21)=dotproduct(ninjaA1,spvae1e2)
      acd172(22)=abb172(39)
      acd172(23)=dotproduct(ninjaA1,spvae1l5)
      acd172(24)=dotproduct(ninjaA1,spval5e1)
      acd172(25)=abb172(63)
      acd172(26)=dotproduct(ninjaA1,spvae1l4)
      acd172(27)=dotproduct(ninjaA0,ninjaE3)
      acd172(28)=abb172(13)
      acd172(29)=dotproduct(ninjaA0,spvak2e1)
      acd172(30)=dotproduct(ninjaA0,spvae1k2)
      acd172(31)=dotproduct(ninjaA0,spvae2e1)
      acd172(32)=dotproduct(ninjaA0,spval4e1)
      acd172(33)=dotproduct(ninjaA0,spvae1e2)
      acd172(34)=dotproduct(ninjaA0,spvae1l5)
      ...
      acd172(47)=abb172(38)
      acd172(48)=abb172(57)
      acd172(49)=acd172(17)*acd172(20)
      acd172(50)=acd172(11)*acd172(2)
      acd172(51)=acd172(22)*acd172(13)
      acd172(52)=acd172(25)*acd172(19)
      acd172(49)=-acd172(52)-acd172(51)+acd172(49)-acd172(50)
      acd172(50)=-acd172(24)*acd172(49)
      acd172(51)=acd172(19)*acd172(20)
      acd172(52)=acd172(9)*acd172(2)
      acd172(53)=acd172(16)*acd172(13)
      acd172(54)=acd172(18)*acd172(17)
      acd172(51)=-acd172(51)+acd172(52)+acd172(53)+acd172(54)
      acd172(52)=acd172(15)*acd172(51)
      ...
      acd172(59)=acd172(20)*acd172(10)
      acd172(60)=acd172(18)*acd172(8)
      acd172(59)=acd172(59)-acd172(60)
      acd172(60)=-acd172(23)*acd172(59)
      acd172(61)=acd172(20)*acd172(8)
      acd172(62)=acd172(25)*acd172(10)
      ...
      acd172(51)=acd172(32)*acd172(51)
      acd172(49)=-acd172(35)*acd172(49)
      acd172(53)=acd172(33)*acd172(55)
      acd172(54)=acd172(31)*acd172(57)
      acd172(55)=-acd172(34)*acd172(59)
      ...
      acd172(62)=acd172(41)*acd172(40)
      acd172(63)=acd172(42)*acd172(8)
      acd172(64)=acd172(43)*acd172(13)
      acd172(65)=acd172(44)*acd172(17)
      acd172(66)=acd172(46)*acd172(45)
      acd172(67)=acd172(47)*acd172(10)
      acd172(68)=acd172(48)*acd172(19)
      ...
      &(57)+acd172(56)+acd172(55)+acd172(54)+acd172(53)+acd172(49)+acd172(51)+a&
      &cd172(52)
...
!---#[ subroutine numerator_t2:
   ...
   & bind(c, name="p2_gg_httbar_d172h0_qp_ninja_t2")
...
!---#] subroutine numerator_t2:
end module     p2_gg_httbar_d172h0l132_qp

module     p2_gg_httbar_d32h8l132_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity8d32h8l132_qp.f90
...
!---#[ subroutine brack_22:
   pure subroutine brack_22(ninjaA0, ninjaA1, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      ninjaP1 = ninjaP(1)
      ninjaP2 = ninjaP(2)
      acd32(1)=dotproduct(ninjaA1,spvak2e1)
      acd32(2)=dotproduct(ninjaE3,spvae1l4)
      acd32(3)=abb32(11)
      acd32(4)=dotproduct(ninjaE3,spvae1e2)
      acd32(5)=abb32(20)
      ...
      acd32(7)=abb32(32)
      acd32(8)=dotproduct(ninjaE3,spvae1l5)
      acd32(9)=abb32(21)
      acd32(10)=dotproduct(ninjaA1,spvae1l4)
      acd32(11)=dotproduct(ninjaE3,spvak2e1)
      acd32(12)=dotproduct(ninjaE3,spval3e1)
      acd32(13)=abb32(46)
      acd32(14)=dotproduct(ninjaA1,spvae2e1)
      acd32(15)=abb32(24)
      acd32(16)=abb32(26)
      acd32(17)=dotproduct(ninjaA1,spvae1e2)
      acd32(18)=abb32(48)
      acd32(19)=dotproduct(ninjaA1,spval3e1)
      acd32(20)=dotproduct(ninjaA1,spvae1l3)
      acd32(21)=dotproduct(ninjaE3,spvae2e1)
      acd32(22)=dotproduct(ninjaE3,spval4e1)
      acd32(23)=abb32(25)
      acd32(24)=dotproduct(ninjaA1,spvae1l5)
      acd32(25)=abb32(29)
      acd32(26)=dotproduct(ninjaA1,spval4e1)
      acd32(27)=dotproduct(ninjaA0,spvak2e1)
      acd32(28)=dotproduct(ninjaA0,spvae1l4)
      acd32(29)=dotproduct(ninjaA0,spvae2e1)
      acd32(30)=dotproduct(ninjaA0,spvae1e2)
      acd32(31)=dotproduct(ninjaA0,spval3e1)
      acd32(32)=dotproduct(ninjaA0,spvae1l3)
      acd32(33)=dotproduct(ninjaA0,spvae1l5)
      acd32(34)=dotproduct(ninjaA0,spval4e1)
      acd32(35)=abb32(10)
      acd32(36)=abb32(27)
      acd32(37)=abb32(14)
      acd32(38)=abb32(15)
      ...
      acd32(51)=acd32(15)*acd32(6)
      acd32(52)=acd32(16)*acd32(8)
      acd32(51)=acd32(51)+acd32(52)
      acd32(52)=-acd32(14)*acd32(51)
      acd32(53)=acd32(5)*acd32(11)
      acd32(54)=acd32(18)*acd32(12)
      acd32(53)=acd32(53)+acd32(54)
      acd32(54)=-acd32(17)*acd32(53)
      acd32(55)=acd32(13)*acd32(2)
      acd32(56)=acd32(18)*acd32(4)
      ...
      acd32(54)=acd32(37)*acd32(21)
      acd32(55)=acd32(38)*acd32(4)
...
!---#[ subroutine numerator_t2:
   ...
   & bind(c, name="p2_gg_httbar_d32h8_qp_ninja_t2")
...
!---#] subroutine numerator_t2:
end module     p2_gg_httbar_d32h8l132_qp

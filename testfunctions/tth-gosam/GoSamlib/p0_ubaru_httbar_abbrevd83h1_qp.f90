module     p0_ubaru_httbar_abbrevd83h1_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb83(5)=gs**4*i_*e
      abb83(6)=TR**2
      abb83(7)=abb83(5)*abb83(6)*spak1l4*gHT
      abb83(8)=abb83(7)*c2
      ...
      abb83(12)=spbl5k2*abb83(10)
      abb83(13)=2.0_ki*abb83(12)
      abb83(14)=-spal4l5*abb83(13)
      abb83(15)=abb83(4)-mT
      ...
      abb83(5)=abb83(6)*gHT*abb83(4)*mT*abb83(5)*abb83(3)
      abb83(6)=spak1l5*spbl5k2*abb83(5)
      abb83(8)=abb83(2)*abb83(3)*mT**2
      abb83(9)=-spak2l5*abb83(12)*abb83(8)
      abb83(6)=abb83(9)+abb83(6)+abb83(7)
      abb83(6)=2.0_ki*abb83(6)
      abb83(7)=4.0_ki*abb83(10)*abb83(8)
      abb83(8)=2.0_ki*abb83(10)
      abb83(9)=spak1l5*abb83(13)
...
end module p0_ubaru_httbar_abbrevd83h1_qp

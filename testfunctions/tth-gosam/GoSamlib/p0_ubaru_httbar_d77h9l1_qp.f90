module     p0_ubaru_httbar_d77h9l1_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity9d77h9l1_qp.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_ubaru_httbar_d77h9l1_qp_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_ubaru_httbar_d77h9l1_qp

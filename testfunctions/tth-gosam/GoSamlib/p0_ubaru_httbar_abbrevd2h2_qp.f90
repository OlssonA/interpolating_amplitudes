module     p0_ubaru_httbar_abbrevd2h2_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb2(10)=abb2(10)*abb2(11)*spbk2k1*abb2(2)
      abb2(12)=spak2l4*mH**2*abb2(4)*abb2(3)
      abb2(13)=abb2(10)*abb2(12)
      abb2(14)=abb2(13)*spak2l5
      abb2(15)=mT**2
      abb2(16)=-abb2(15)*abb2(10)
      abb2(17)=abb2(5)*spak2l5
      ...
      abb2(24)=abb2(23)*spal3l4
      abb2(25)=abb2(24)*spbl3k1
      abb2(26)=abb2(25)*spak2l5
      abb2(26)=abb2(26)+abb2(14)
      abb2(27)=abb2(7)*abb2(6)
      abb2(28)=abb2(19)*abb2(27)
      abb2(29)=abb2(16)*abb2(6)
      abb2(30)=abb2(28)+abb2(29)
      abb2(31)=abb2(30)*spak2l4
      abb2(32)=spbl3k2*abb2(5)
      abb2(33)=abb2(32)*spak2l3
      ...
      abb2(25)=spak2l5**2
      abb2(37)=-spbl5k2*abb2(25)*abb2(13)
      abb2(39)=abb2(9)*spbk2k1
      abb2(40)=abb2(11)*spbk2k1
      ...
      abb2(9)=spal3l4*abb2(9)
      abb2(11)=abb2(21)*spak2l5
      abb2(21)=-spak1l5*abb2(11)
      abb2(9)=abb2(9)+abb2(21)
      abb2(9)=spbl3k1*abb2(9)
      ...
      abb2(25)=abb2(23)*spak2l5
      abb2(27)=-2.0_ki*abb2(25)+abb2(22)
      abb2(27)=spbl3k1*spal3l4*abb2(27)
      ...
      abb2(21)=abb2(15)*abb2(6)
      abb2(26)=abb2(22)+abb2(21)
      abb2(27)=spak2l4*abb2(26)
      abb2(20)=abb2(20)*abb2(19)
      abb2(17)=abb2(15)*abb2(17)
      abb2(31)=-abb2(25)*abb2(12)
      abb2(33)=abb2(33)*abb2(21)
      abb2(17)=abb2(33)+abb2(31)+abb2(27)+abb2(17)+abb2(20)
      abb2(17)=spbl5k1*abb2(17)
      abb2(27)=abb2(23)*abb2(7)
      abb2(31)=abb2(27)-abb2(19)
      abb2(31)=spak2l4*abb2(7)*abb2(31)
      abb2(33)=abb2(19)*abb2(38)
      abb2(35)=-spak2l3*spbl3k2*abb2(33)
      abb2(31)=abb2(31)+abb2(35)
      abb2(35)=spak2l5*abb2(19)
      abb2(37)=-abb2(7)*abb2(25)
      abb2(35)=abb2(35)+abb2(37)
      abb2(35)=abb2(7)*abb2(35)
      abb2(37)=-spbl3k2*abb2(45)
      abb2(20)=spbl3k2*abb2(20)
      abb2(28)=-abb2(29)+abb2(28)
      abb2(28)=spal3l4*abb2(28)
      abb2(13)=-2.0_ki*abb2(13)
      abb2(13)=spak1l5*abb2(13)
      abb2(21)=2.0_ki*abb2(21)
      abb2(22)=-4.0_ki*abb2(22)+abb2(21)+abb2(25)
      abb2(22)=spal3l4*abb2(22)
      abb2(25)=abb2(15)*abb2(5)
      abb2(38)=abb2(25)-2.0_ki*abb2(33)
      abb2(38)=spal3l5*abb2(38)
      abb2(22)=2.0_ki*abb2(38)+abb2(22)
      abb2(22)=spbl3k2*abb2(22)
      abb2(30)=spak1l4*abb2(30)
      abb2(19)=2.0_ki*abb2(27)-abb2(19)
      abb2(19)=abb2(7)*abb2(19)
      abb2(15)=abb2(19)+abb2(15)
      abb2(15)=spal4l5*abb2(15)
      abb2(19)=abb2(32)*abb2(29)*spak1l3
      abb2(13)=abb2(19)+2.0_ki*abb2(15)+abb2(30)+abb2(13)+abb2(22)
      abb2(15)=-2.0_ki*abb2(24)
      abb2(12)=-abb2(23)*abb2(12)
      abb2(12)=abb2(12)+abb2(25)+abb2(33)
      abb2(12)=2.0_ki*abb2(12)
      abb2(19)=2.0_ki*abb2(26)
...
end module p0_ubaru_httbar_abbrevd2h2_qp

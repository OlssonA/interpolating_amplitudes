module     p0_ubaru_httbar_d64h5l131_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity5d64h5l131_qp.f90
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      acd64(2)=dotproduct(ninjaE3,spvak1k2)
      acd64(3)=abb64(10)
      acd64(4)=dotproduct(ninjaE3,spval3k2)
      acd64(5)=abb64(11)
      acd64(6)=dotproduct(k2,ninjaA)
      acd64(7)=dotproduct(ninjaA,spvak1k2)
      acd64(8)=abb64(13)
      ...
      acd64(12)=abb64(9)
      acd64(13)=abb64(28)
      acd64(14)=dotproduct(ninjaE3,spvak1l4)
      acd64(15)=abb64(17)
      acd64(16)=dotproduct(ninjaE3,spval5l4)
      acd64(17)=abb64(19)
      acd64(18)=dotproduct(ninjaE3,spvak1l3)
      acd64(19)=abb64(20)
      acd64(20)=dotproduct(ninjaE3,spval5l3)
      acd64(21)=abb64(21)
      acd64(22)=dotproduct(ninjaE3,spval5k2)
      acd64(23)=abb64(24)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p0_ubaru_httbar_d64h5_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p0_ubaru_httbar_d64h5l131_qp

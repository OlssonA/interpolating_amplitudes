module     p2_gg_httbar_d2h0l131_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity0d2h0l131_qp.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_gg_httbar_abbrevd2h0_qp
      implicit none
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd2(1)=dotproduct(ninjaE3,spval4k2)
      acd2(2)=abb2(7)
      acd2(3)=dotproduct(ninjaE3,spval3k2)
      acd2(4)=abb2(8)
      acd2(5)=dotproduct(ninjaE3,spvae1e2)
      acd2(6)=abb2(10)
      acd2(7)=dotproduct(ninjaE3,spval5k2)
      acd2(8)=abb2(11)
      acd2(9)=dotproduct(ninjaE3,spval4l3)
      acd2(10)=abb2(13)
      acd2(11)=dotproduct(ninjaE3,spvae2e1)
      acd2(12)=abb2(21)
      acd2(13)=dotproduct(ninjaA,spval4k2)
      acd2(14)=dotproduct(ninjaA,spval3k2)
      acd2(15)=dotproduct(ninjaA,spvae1e2)
      acd2(16)=dotproduct(ninjaA,spval5k2)
      acd2(17)=dotproduct(ninjaA,spval4l3)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_gg_httbar_d2h0_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_gg_httbar_d2h0l131_qp

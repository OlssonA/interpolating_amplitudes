module     p0_ubaru_httbar_diagramsh9l0_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity9diagramsl0_qp.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(3)=spak2l5**(-1)
      abb(4)=sqrt(mT**2)
      abb(5)=1.0_ki/(-mT**2+es34)
      abb(6)=spbl4k2**(-1)
      abb(7)=NC**(-1)
      abb(8)=spak1l4*spak2l3*abb(1)
      abb(9)=abb(5)*spak1k2*spal3l4
      abb(8)=abb(8)-abb(9)
      abb(8)=abb(8)*abb(3)
      abb(9)=spak1l3*abb(5)*abb(6)*spbl5k2
      abb(8)=abb(8)+abb(9)
      abb(8)=spbl3k2*abb(8)
      abb(9)=abb(1)+abb(5)
      abb(10)=spak1l4*spbl5k2
      abb(11)=abb(10)*abb(9)
      abb(8)=abb(11)+abb(8)
...
!---#] function amplitude:
end module p0_ubaru_httbar_diagramsh9l0_qp

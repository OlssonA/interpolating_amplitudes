program test
   use p2_gg_httbar_config, only: ki, logfile, nlo_prefactors
   use p2_gg_httbar_kinematics, only: dotproduct, boost_to_cms
   use p2_gg_httbar_model, only: parse
   use p2_gg_httbar_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p2_gg_httbar_color, only: numcs, CA
   use p2_gg_httbar_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p2_gg_httbar_config, only: renormalisation, &

module     p0_ubaru_httbar_diagramsh6l0_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity6diagramsl0_qp.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(6)=spak2l4**(-1)
      abb(7)=NC**(-1)
      abb(8)=spbl4k1*spbl3k2*abb(1)
      abb(9)=abb(5)*spbk2k1*spbl4l3
      abb(8)=abb(8)-abb(9)
      abb(8)=abb(8)*abb(3)
      abb(9)=spbl3k1*abb(5)*abb(6)*spak2l5
      abb(8)=abb(8)+abb(9)
      abb(8)=spak2l3*abb(8)
      abb(9)=abb(1)+abb(5)
      abb(10)=spbl4k1*spak2l5
      abb(11)=abb(10)*abb(9)
      abb(8)=abb(11)+abb(8)
...
!---#] function amplitude:
end module p0_ubaru_httbar_diagramsh6l0_qp

module     p0_ubaru_httbar_diagramsh2l0_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity2diagramsl0_qp.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(10)=abb(11)*spbk2k1*abb(10)
      abb(12)=abb(5)*spak2l5
      abb(13)=abb(6)*spak2l4
      ...
      abb(10)=spak2l5*abb(10)*abb(3)*abb(4)*mH**2
      abb(11)=abb(11)*spbl3k1
      abb(14)=abb(1)*abb(11)*spal3l5
      abb(10)=abb(10)+abb(14)
      abb(10)=abb(10)*spak2l4
      abb(11)=abb(8)*spak2l5*abb(11)*spal3l4
...
!---#] function amplitude:
end module p0_ubaru_httbar_diagramsh2l0_qp

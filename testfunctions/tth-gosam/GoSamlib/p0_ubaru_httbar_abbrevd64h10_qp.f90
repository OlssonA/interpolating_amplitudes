module     p0_ubaru_httbar_abbrevd64h10_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb64(30)=spak2l4*abb64(28)*abb64(29)
      abb64(31)=abb64(8)**2
      ...
      abb64(19)=spak2l5*abb64(17)
      abb64(17)=spak1k2*abb64(17)
      abb64(9)=abb64(9)*spbl3k2
      abb64(20)=2.0_ki*abb64(9)
      abb64(21)=-spak2l5*abb64(20)
      abb64(20)=-spak1k2*abb64(20)
      abb64(24)=-spal4l5*abb64(11)
      abb64(26)=spal3l5*abb64(9)
      abb64(24)=abb64(24)+abb64(26)
      abb64(24)=2.0_ki*abb64(24)
      abb64(26)=2.0_ki*spal3l4
      ...
      abb64(11)=-abb64(6)*abb64(11)*abb64(26)
      R2d64=0.0_ki
      rat2 = rat2 + R2d64
...
end module p0_ubaru_httbar_abbrevd64h10_qp

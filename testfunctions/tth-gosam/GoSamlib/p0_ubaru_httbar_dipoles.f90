module     p0_ubaru_httbar_dipoles
   use p0_ubaru_httbar_config, only: ki
   use p0_ubaru_httbar_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T4, &
       & T1T5, &
       ...
       & T2T5, &
       & T4T5
   use p0_ubaru_httbar_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p0_ubaru_httbar_dipoles

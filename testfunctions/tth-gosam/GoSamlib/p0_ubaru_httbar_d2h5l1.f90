module     p0_ubaru_httbar_d2h5l1
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity5d2h5l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc2(15)=acc2(4)*Qspval5l4
      acc2(16)=acc2(7)*Qspval5l3
      acc2(17)=acc2(8)*Qspval3k2
      acc2(14)=acc2(17)+acc2(16)+acc2(15)+acc2(1)+acc2(14)
      acc2(14)=Qspvak1k2*acc2(14)
      acc2(15)=QspQ+Qspl5
      acc2(15)=acc2(9)*acc2(15)
      acc2(16)=acc2(5)*Qspk2
      acc2(17)=acc2(6)*Qspval3k2
      acc2(18)=acc2(12)*Qspval5l4
      acc2(19)=acc2(13)*Qspval5l3
      acc2(20)=Qspval5k2*acc2(10)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_ubaru_httbar_d2h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_ubaru_httbar_d2h5l1

module     p2_gg_httbar_abbrevd1h4_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb1(21)=spbl3e1*spbk2e2*abb1(21)
      abb1(22)=abb1(5)*abb1(6)
      abb1(23)=spae1e2*spbe2e1
      ...
      abb1(34)=spbe2e1*abb1(34)
      abb1(35)=abb1(4)*mH**2*abb1(3)*spbl4k2
      abb1(21)=-abb1(21)*abb1(35)
      abb1(21)=abb1(34)+abb1(21)
      abb1(21)=spae1k2*spae2l5*abb1(21)
      ...
      abb1(28)=spbl4e2*spbk2e1*abb1(28)
      abb1(29)=-abb1(14)+c2
      abb1(20)=abb1(20)*abb1(29)
      abb1(10)=1.0_ki/2.0_ki*abb1(10)+abb1(20)
      abb1(10)=spbl4e1*spbk2e2*abb1(10)
      ...
      abb1(22)=abb1(6)*abb1(8)
      abb1(28)=abb1(22)*abb1(14)
      abb1(29)=abb1(22)*c2
      abb1(30)=abb1(6)*abb1(32)*c3
      abb1(28)=abb1(29)-abb1(28)+1.0_ki/2.0_ki*abb1(30)
      abb1(31)=-abb1(28)*abb1(35)
      abb1(33)=1.0_ki/2.0_ki*abb1(6)
      abb1(33)=-abb1(33)*abb1(9)
      abb1(34)=-abb1(6)*abb1(20)
      abb1(7)=abb1(31)+abb1(7)+abb1(33)+abb1(34)
      abb1(7)=spae1k2*abb1(7)
      abb1(28)=-spae1l3*spbl4l3*abb1(28)
      abb1(7)=abb1(28)+abb1(7)
      abb1(7)=spbk2e2*abb1(7)
      abb1(18)=abb1(18)+abb1(32)
      abb1(18)=abb1(18)*c3
      abb1(19)=abb1(8)+abb1(19)
      abb1(28)=abb1(19)*c2
      abb1(31)=abb1(18)-abb1(28)
      abb1(33)=c1*abb1(19)
      abb1(31)=1.0_ki/2.0_ki*abb1(31)+abb1(33)
      abb1(31)=spbl4e2*abb1(31)
      abb1(32)=abb1(11)*abb1(32)
      abb1(33)=-abb1(8)*abb1(16)
      abb1(33)=abb1(32)+abb1(33)
      abb1(25)=abb1(8)*abb1(25)
      abb1(25)=1.0_ki/2.0_ki*abb1(33)+abb1(25)
      abb1(25)=spbl3e2*spak2l3*abb1(25)
      abb1(25)=abb1(25)+abb1(31)
      abb1(25)=spae1l5*abb1(25)
      abb1(7)=abb1(25)+abb1(7)
      abb1(9)=-abb1(9)+abb1(20)
      abb1(9)=1.0_ki/2.0_ki*abb1(9)-abb1(13)
      abb1(9)=abb1(6)*abb1(9)
      abb1(13)=abb1(30)-abb1(29)
      abb1(20)=abb1(22)*c1
      abb1(13)=abb1(20)+1.0_ki/2.0_ki*abb1(13)
      abb1(20)=-abb1(13)*abb1(35)
      abb1(9)=abb1(20)+abb1(9)
      abb1(9)=spae2k2*abb1(9)
      abb1(13)=-spae2l3*spbl4l3*abb1(13)
      abb1(9)=abb1(13)+abb1(9)
      abb1(9)=spbk2e1*abb1(9)
      abb1(13)=abb1(19)*abb1(14)
      abb1(19)=-abb1(13)+1.0_ki/2.0_ki*abb1(18)+abb1(28)
      abb1(19)=spbl4e1*abb1(19)
      abb1(8)=-abb1(8)*abb1(17)
      abb1(8)=1.0_ki/2.0_ki*abb1(32)+abb1(8)
      abb1(8)=spbl3e1*spak2l3*abb1(8)
      abb1(8)=abb1(8)+abb1(19)
      abb1(8)=spae2l5*abb1(8)
      abb1(8)=abb1(8)+abb1(9)
      abb1(9)=abb1(13)+abb1(18)+1.0_ki/2.0_ki*abb1(28)
      abb1(9)=abb1(23)*abb1(9)
      abb1(13)=abb1(15)+1.0_ki/2.0_ki*abb1(16)
      abb1(13)=abb1(13)*abb1(27)
      abb1(11)=mT*abb1(11)
      abb1(11)=abb1(11)+abb1(13)
      abb1(11)=spak2l3*spae1e2*abb1(24)*abb1(11)
      abb1(13)=-abb1(14)-1.0_ki/2.0_ki*c2
      abb1(12)=abb1(12)*abb1(13)
      abb1(12)=-abb1(26)+abb1(12)
      abb1(12)=spbl4l3*abb1(12)
      R2d1=0.0_ki
      rat2 = rat2 + R2d1
...
end module p2_gg_httbar_abbrevd1h4_qp

module     p2_gg_httbar_d2h12l1d_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d2h12l1d_qp.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd2(1)=dotproduct(qshift,spvak2l3)
      acd2(2)=abb2(8)
      acd2(3)=dotproduct(qshift,spvak2l4)
      acd2(4)=abb2(7)
      acd2(5)=dotproduct(qshift,spvak2l5)
      acd2(6)=abb2(13)
      acd2(7)=dotproduct(qshift,spval3l4)
      acd2(8)=abb2(11)
...
!---#] function derivative:
end module     p2_gg_httbar_d2h12l1d_qp

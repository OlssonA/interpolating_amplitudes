module     p2_gg_httbar_kinematics_qp
   use p2_gg_httbar_config, only: ki => ki_qp
   use p2_gg_httbar_model_qp
   use p2_gg_httbar_scalar_cache
   implicit none
   save
   ...
   complex(ki), public :: spal3l5, spbl5l3
   ...
   complex(ki), dimension(4), public :: spval3l5
   ...
   complex(ki), dimension(4), public :: spval5l3
   ...
   complex(ki), public :: spae1l5, spbl5e1
   ...
   complex(ki), dimension(4), public :: spval5e1, spvae1l5
...
!---#[ subroutine inspect_kinematics:
   subroutine     inspect_kinematics(unit)
      ...
      write(ch,'(A27,G24.16,A3)') &
         & "<component name='m' value='", real(mT, ki), "'/>"
      write(ch,*) "<!-- k4.k4 = ", &
         & dotproduct(k4,k4), "-->"
      write(ch,*) "</momentum>"
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2)
      use p2_gg_httbar_config, only: debug_numpolvec, logfile
      use p2_gg_httbar_model_qp
      implicit none
      ...
      ! mass1 = 'mT', mass2 = '0'
      call light_cone_decomposition(k4, l4, k2, mT)
      ! mass1 = 'mT', mass2 = '0'
      call light_cone_decomposition(k5, l5, k2, mT)
      ...
      if(.true. .and. present(hel1) .and. present(hel2)) then
         ...
         if(flag1) then
            spae1l5 = N1 * Spaa(k1, l5)
            spbl5e1 = N1 * Spbb(l5, k2)
         else
            spae1l5 = N1 * Spaa(k2, l5)
            spbl5e1 = N1 * Spbb(l5, k1)
         end if
         if(flag2) then
            spak2e2 = 0.0_ki
         ...
         if (flag1) then
            spval5e1 = N1 * Spab3_vec(l5, k2)
            spvae1l5 = N1 * Spab3_vec(k1, l5)
         else
            spval5e1 = N1 * Spab3_vec(l5, k1)
            spvae1l5 = N1 * Spab3_vec(k2, l5)
         end if
         if (flag2) then
         ...
         if (debug_numpolvec) then
            ...
            write(logfile, *) "<1|e1|5]", &
              & dotproduct(spvak1l5, e1), spae1k1*(-1.0_ki)*spbl5e1*(-1.0_ki)
            ...
            write(logfile, *) "<2|e1|5]", &
              & dotproduct(spvak2l5, e1), spae1k2*(-1.0_ki)*spbl5e1*(-1.0_ki)
            ...
            write(logfile, *) "<3|e1|5]", &
              & dotproduct(spval3l5, e1), spae1l3*(-1.0_ki)*spbl5e1*(-1.0_ki)
            write(logfile, *) "<3|e2|5]", &
              & dotproduct(spval3l5, e2), spae2l3*(-1.0_ki)*spbl5e2*(-1.0_ki)
            ...
            write(logfile, *) "<4|e1|5]", &
              & dotproduct(spval4l5, e1), spae1l4*(-1.0_ki)*spbl5e1*(-1.0_ki)
            write(logfile, *) "<4|e2|5]", &
              & dotproduct(spval4l5, e2), spae2l4*(-1.0_ki)*spbl5e2*(-1.0_ki)
            write(logfile, *) "<5|e1|1]", &
              & dotproduct(spval5k1, e1), spae1l5*(-1.0_ki)*spbe1k1
            write(logfile, *) "<5|e2|1]", &
              & dotproduct(spval5k1, e2), spae2l5*(-1.0_ki)*spbe2k1
            write(logfile, *) "<5|e1|2]", &
              & dotproduct(spval5k2, e1), spae1l5*(-1.0_ki)*spbk2e1*(-1.0_ki)
            write(logfile, *) "<5|e2|2]", &
              & dotproduct(spval5k2, e2), spae2l5*(-1.0_ki)*spbe2k2
            write(logfile, *) "<5|e1|3]", &
              & dotproduct(spval5l3, e1), spae1l5*(-1.0_ki)*spbl3e1*(-1.0_ki)
            write(logfile, *) "<5|e2|3]", &
              & dotproduct(spval5l3, e2), spae2l5*(-1.0_ki)*spbl3e2*(-1.0_ki)
            write(logfile, *) "<5|e1|4]", &
              & dotproduct(spval5l4, e1), spae1l5*(-1.0_ki)*spbl4e1*(-1.0_ki)
            ...
            & (-spbe1k1)*dotproduct(spvae1e2, k1)*spae2l5, 2.0_ki*dotproduct(k1, e1)*dotproduct(spval5k1, e2)
            write(logfile, *) "[1|e1]<e1|2|e2]<e2|5>", &
            & (-spbe1k1)*dotproduct(spvae1e2, k2)*spae2l5, dotproduct(spvak2k1, e1)*dotproduct(spval5k2, e2)
            ...
            & spbk2e1*dotproduct(spvae1e2, k1)*spae2l5, dotproduct(spvak1k2, e1)*dotproduct(spval5k1, e2)
            write(logfile, *) "[2|e1]<e1|2|e2]<e2|5>", &
            & spbk2e1*dotproduct(spvae1e2, k2)*spae2l5, 2.0_ki*dotproduct(k2, e1)*dotproduct(spval5k2, e2)
            ...
            & spbl3e1*dotproduct(spvae1e2, k1)*spae2l5, dotproduct(spvak1l3, e1)*dotproduct(spval5k1, e2)
            write(logfile, *) "[3|e1]<e1|2|e2]<e2|5>", &
            & spbl3e1*dotproduct(spvae1e2, k2)*spae2l5, dotproduct(spvak2l3, e1)*dotproduct(spval5k2, e2)
            ...
            & spbl4e1*dotproduct(spvae1e2, k1)*spae2l5, dotproduct(spvak1l4, e1)*dotproduct(spval5k1, e2)
            write(logfile, *) "[4|e1]<e1|2|e2]<e2|5>", &
            & spbl4e1*dotproduct(spvae1e2, k2)*spae2l5, dotproduct(spvak2l4, e1)*dotproduct(spval5k2, e2)
            write(logfile, *) "[5|e1]<e1|1|e2]<e2|1>", &
            & spbl5e1*dotproduct(spvae1e2, k1)*(-spak1e2), dotproduct(spvak1l5, e1)*2.0_ki*dotproduct(k1, e2)
            write(logfile, *) "[5|e1]<e1|2|e2]<e2|1>", &
            & spbl5e1*dotproduct(spvae1e2, k2)*(-spak1e2), dotproduct(spvak2l5, e1)*dotproduct(spvak1k2, e2)
            write(logfile, *) "[5|e1]<e1|1|e2]<e2|2>", &
            & spbl5e1*dotproduct(spvae1e2, k1)*(-spak2e2), dotproduct(spvak1l5, e1)*dotproduct(spvak2k1, e2)
            write(logfile, *) "[5|e1]<e1|2|e2]<e2|2>", &
            & spbl5e1*dotproduct(spvae1e2, k2)*(-spak2e2), dotproduct(spvak2l5, e1)*2.0_ki*dotproduct(k2, e2)
            write(logfile, *) "[5|e1]<e1|1|e2]<e2|3>", &
            & spbl5e1*dotproduct(spvae1e2, k1)*spae2l3, dotproduct(spvak1l5, e1)*dotproduct(spval3k1, e2)
            write(logfile, *) "[5|e1]<e1|2|e2]<e2|3>", &
            & spbl5e1*dotproduct(spvae1e2, k2)*spae2l3, dotproduct(spvak2l5, e1)*dotproduct(spval3k2, e2)
            write(logfile, *) "[5|e1]<e1|1|e2]<e2|4>", &
            & spbl5e1*dotproduct(spvae1e2, k1)*spae2l4, dotproduct(spvak1l5, e1)*dotproduct(spval4k1, e2)
            write(logfile, *) "[5|e1]<e1|2|e2]<e2|4>", &
            & spbl5e1*dotproduct(spvae1e2, k2)*spae2l4, dotproduct(spvak2l5, e1)*dotproduct(spval4k2, e2)
            write(logfile, *) "[5|e1]<e1|1|e2]<e2|5>", &
            & spbl5e1*dotproduct(spvae1e2, k1)*spae2l5, dotproduct(spvak1l5, e1)*dotproduct(spval5k1, e2)
            write(logfile, *) "[5|e1]<e1|2|e2]<e2|5>", &
            & spbl5e1*dotproduct(spvae1e2, k2)*spae2l5, dotproduct(spvak2l5, e1)*dotproduct(spval5k2, e2)
            ...
            & (-spbe2k1)*dotproduct(spvae2e1, k1)*spae1l5, 2.0_ki*dotproduct(k1, e2)*dotproduct(spval5k1, e1)
            write(logfile, *) "[1|e2]<e2|2|e1]<e1|5>", &
            & (-spbe2k1)*dotproduct(spvae2e1, k2)*spae1l5, dotproduct(spvak2k1, e2)*dotproduct(spval5k2, e1)
            ...
            & (-spbe2k2)*dotproduct(spvae2e1, k1)*spae1l5, dotproduct(spvak1k2, e2)*dotproduct(spval5k1, e1)
            write(logfile, *) "[2|e2]<e2|2|e1]<e1|5>", &
            & (-spbe2k2)*dotproduct(spvae2e1, k2)*spae1l5, 2.0_ki*dotproduct(k2, e2)*dotproduct(spval5k2, e1)
            ...
            & spbl3e2*dotproduct(spvae2e1, k1)*spae1l5, dotproduct(spvak1l3, e2)*dotproduct(spval5k1, e1)
            write(logfile, *) "[3|e2]<e2|2|e1]<e1|5>", &
            & spbl3e2*dotproduct(spvae2e1, k2)*spae1l5, dotproduct(spvak2l3, e2)*dotproduct(spval5k2, e1)
            ...
            & spbl4e2*dotproduct(spvae2e1, k1)*spae1l5, dotproduct(spvak1l4, e2)*dotproduct(spval5k1, e1)
            write(logfile, *) "[4|e2]<e2|2|e1]<e1|5>", &
            & spbl4e2*dotproduct(spvae2e1, k2)*spae1l5, dotproduct(spvak2l4, e2)*dotproduct(spval5k2, e1)
            write(logfile, *) "[5|e2]<e2|1|e1]<e1|1>", &
            & spbl5e2*dotproduct(spvae2e1, k1)*(-spak1e1), dotproduct(spvak1l5, e2)*2.0_ki*dotproduct(k1, e1)
            write(logfile, *) "[5|e2]<e2|2|e1]<e1|1>", &
            & spbl5e2*dotproduct(spvae2e1, k2)*(-spak1e1), dotproduct(spvak2l5, e2)*dotproduct(spvak1k2, e1)
            write(logfile, *) "[5|e2]<e2|1|e1]<e1|2>", &
            & spbl5e2*dotproduct(spvae2e1, k1)*spae1k2, dotproduct(spvak1l5, e2)*dotproduct(spvak2k1, e1)
            write(logfile, *) "[5|e2]<e2|2|e1]<e1|2>", &
            & spbl5e2*dotproduct(spvae2e1, k2)*spae1k2, dotproduct(spvak2l5, e2)*2.0_ki*dotproduct(k2, e1)
            write(logfile, *) "[5|e2]<e2|1|e1]<e1|3>", &
            & spbl5e2*dotproduct(spvae2e1, k1)*spae1l3, dotproduct(spvak1l5, e2)*dotproduct(spval3k1, e1)
            write(logfile, *) "[5|e2]<e2|2|e1]<e1|3>", &
            & spbl5e2*dotproduct(spvae2e1, k2)*spae1l3, dotproduct(spvak2l5, e2)*dotproduct(spval3k2, e1)
            write(logfile, *) "[5|e2]<e2|1|e1]<e1|4>", &
            & spbl5e2*dotproduct(spvae2e1, k1)*spae1l4, dotproduct(spvak1l5, e2)*dotproduct(spval4k1, e1)
            write(logfile, *) "[5|e2]<e2|2|e1]<e1|4>", &
            & spbl5e2*dotproduct(spvae2e1, k2)*spae1l4, dotproduct(spvak2l5, e2)*dotproduct(spval4k2, e1)
            write(logfile, *) "[5|e2]<e2|1|e1]<e1|5>", &
            & spbl5e2*dotproduct(spvae2e1, k1)*spae1l5, dotproduct(spvak1l5, e2)*dotproduct(spval5k1, e1)
            write(logfile, *) "[5|e2]<e2|2|e1]<e1|5>", &
            & spbl5e2*dotproduct(spvae2e1, k2)*spae1l5, dotproduct(spvak2l5, e2)*dotproduct(spval5k2, e1)
...
!---#] functions dotproduct_XX:
   ...
   pure subroutine adjust_kinematics(vecs)
      ...
      vecs(3,1) = sign(sqrt(vecs(3,2)**2 + vecs(3,3)**2 + vecs(3,4)**2 + mH**2),vecs(3,1))
      s0 = mT**2
      s1 = mT**2
   ...
   !---#] function epsom :
end module p2_gg_httbar_kinematics_qp

module     p0_ubaru_httbar_d58h2l1
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity2d58h2l1.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_ubaru_httbar_d58h2l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_ubaru_httbar_d58h2l1

module     p2_gg_httbar_d84h8l1_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity8d84h8l1_qp.f90
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p2_gg_httbar_d84h8l1_qp_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p2_gg_httbar_d84h8l1_qp

module     p2_gg_httbar_d261h12l131_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d261h12l131_qp.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_gg_httbar_abbrevd261h12_qp
      implicit none
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd261(1)=dotproduct(ninjaE3,spvak2e1)
      acd261(2)=dotproduct(ninjaE3,spvae2l5)
      acd261(3)=dotproduct(ninjaE3,spvae1e2)
      acd261(4)=abb261(41)
      acd261(5)=dotproduct(ninjaE3,spvak2e2)
      acd261(6)=dotproduct(ninjaE3,spvae2e1)
      acd261(7)=dotproduct(ninjaE3,spvae1l4)
      acd261(8)=abb261(65)
      acd261(9)=dotproduct(ninjaA,ninjaE3)
      acd261(10)=abb261(33)
      acd261(11)=dotproduct(ninjaE3,spval3l4)
      acd261(12)=abb261(58)
      acd261(13)=dotproduct(ninjaE3,spvae1k2)
      acd261(14)=abb261(11)
      acd261(15)=abb261(24)
      acd261(16)=abb261(59)
      acd261(17)=abb261(15)
      acd261(18)=dotproduct(ninjaE3,spvae1l3)
      acd261(19)=abb261(48)
      acd261(20)=dotproduct(ninjaE3,spvak2l4)
      acd261(21)=abb261(19)
      acd261(22)=dotproduct(ninjaE3,spvak2l5)
      acd261(23)=abb261(21)
      acd261(24)=abb261(34)
      acd261(25)=dotproduct(ninjaE3,spval3l5)
      acd261(26)=abb261(38)
      acd261(27)=dotproduct(ninjaE3,spvak1e2)
      acd261(28)=abb261(47)
      acd261(29)=dotproduct(ninjaA,spvak2e1)
      acd261(30)=dotproduct(ninjaA,spvak2e2)
      acd261(31)=dotproduct(ninjaA,spvae2l5)
      acd261(32)=dotproduct(ninjaA,spvae1e2)
      acd261(33)=dotproduct(ninjaA,spvae2e1)
      acd261(34)=dotproduct(ninjaA,spvae1l4)
      acd261(35)=abb261(7)
      acd261(36)=abb261(17)
      acd261(37)=abb261(10)
      acd261(38)=abb261(14)
      ...
      acd261(46)=abb261(62)
      acd261(47)=abb261(26)
      acd261(48)=dotproduct(ninjaE3,spval3e1)
      acd261(49)=abb261(55)
      acd261(50)=abb261(32)
      acd261(51)=abb261(46)
      acd261(52)=abb261(53)
      acd261(53)=abb261(52)
      acd261(54)=dotproduct(ninjaE3,spvae2l4)
      acd261(55)=abb261(23)
      acd261(56)=abb261(37)
      acd261(57)=abb261(54)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_gg_httbar_d261h12_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_gg_httbar_d261h12l131_qp

module     p2_gg_httbar_d1h12l1d_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d1h12l1d_qp.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd1(1)=dotproduct(qshift,spvak2l3)
      acd1(2)=abb1(9)
      acd1(3)=dotproduct(qshift,spvak2l4)
      acd1(4)=abb1(8)
      acd1(5)=dotproduct(qshift,spvak2l5)
      acd1(6)=abb1(7)
      acd1(7)=dotproduct(qshift,spval3l5)
      acd1(8)=abb1(11)
...
!---#] function derivative:
end module     p2_gg_httbar_d1h12l1d_qp

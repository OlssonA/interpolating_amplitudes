module     p2_gg_httbar_d172h12l1d
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity12d172h12l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      acd172(12)=abb172(15)
      acd172(13)=abb172(14)
      acd172(14)=dotproduct(qshift,spval4e1)
      acd172(15)=abb172(86)
      acd172(16)=dotproduct(qshift,spval5e1)
      acd172(17)=abb172(24)
      acd172(18)=dotproduct(qshift,spvae2e1)
      acd172(19)=abb172(23)
      acd172(20)=abb172(22)
      acd172(21)=abb172(57)
      acd172(22)=abb172(39)
      ...
      acd172(32)=abb172(31)
      acd172(33)=abb172(12)
      acd172(34)=acd172(4)*acd172(5)
      acd172(35)=acd172(10)*acd172(11)
      acd172(36)=acd172(8)*acd172(9)
      acd172(37)=acd172(6)*acd172(7)
      acd172(34)=acd172(37)+acd172(36)+acd172(35)-acd172(12)+acd172(34)
      acd172(34)=acd172(3)*acd172(34)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd172(15)=abb172(14)
      acd172(16)=spvae1l4(iv1)
      acd172(17)=dotproduct(qshift,spval4e1)
      acd172(18)=abb172(86)
      acd172(19)=dotproduct(qshift,spval5e1)
      acd172(20)=abb172(24)
      acd172(21)=dotproduct(qshift,spvae2e1)
      acd172(22)=abb172(23)
      acd172(23)=abb172(22)
      ...
      acd172(34)=abb172(21)
      acd172(35)=spval4e1(iv1)
      acd172(36)=abb172(25)
      acd172(37)=spval5e1(iv1)
      acd172(38)=abb172(56)
      acd172(39)=spvae2e1(iv1)
      acd172(40)=abb172(31)
      acd172(41)=-acd172(17)*acd172(25)
      acd172(42)=-acd172(21)*acd172(26)
      acd172(43)=-acd172(18)*acd172(19)
      acd172(44)=-acd172(14)*acd172(9)
      ...
      acd172(45)=-acd172(14)*acd172(7)
      acd172(42)=acd172(45)+acd172(44)+acd172(43)+acd172(23)+acd172(42)
      acd172(42)=acd172(16)*acd172(42)
      acd172(43)=-acd172(10)*acd172(11)
      acd172(44)=-acd172(5)*acd172(4)
      acd172(45)=-acd172(8)*acd172(9)
      acd172(46)=-acd172(6)*acd172(7)
      acd172(43)=acd172(46)+acd172(45)+acd172(44)+acd172(12)+acd172(43)
      acd172(43)=acd172(3)*acd172(43)
      ...
      acd172(45)=acd172(6)*acd172(45)
      acd172(46)=-acd172(5)*acd172(13)
      acd172(47)=-acd172(28)*acd172(11)
      acd172(46)=acd172(46)+acd172(47)
      acd172(46)=acd172(14)*acd172(46)
      ...
      acd172(51)=acd172(13)*acd172(15)
      acd172(52)=acd172(37)*acd172(38)
      acd172(53)=acd172(35)*acd172(36)
      acd172(54)=-acd172(10)*acd172(29)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd172(27)=abb172(39)
      acd172(28)=abb172(54)
      acd172(29)=acd172(11)*acd172(16)
      acd172(30)=acd172(5)*acd172(13)
      acd172(31)=acd172(15)*acd172(9)
      acd172(32)=acd172(14)*acd172(7)
      acd172(29)=acd172(32)+acd172(31)+acd172(29)+acd172(30)
      acd172(29)=acd172(12)*acd172(29)
      acd172(30)=acd172(10)*acd172(11)
      acd172(31)=acd172(5)*acd172(4)
      acd172(32)=acd172(8)*acd172(9)
      acd172(33)=acd172(6)*acd172(7)
      acd172(30)=acd172(33)+acd172(32)+acd172(30)+acd172(31)
      acd172(30)=acd172(3)*acd172(30)
      ...
      acd172(34)=acd172(6)*acd172(34)
      acd172(35)=acd172(25)*acd172(10)
...
!---#] function derivative:
end module     p2_gg_httbar_d172h12l1d

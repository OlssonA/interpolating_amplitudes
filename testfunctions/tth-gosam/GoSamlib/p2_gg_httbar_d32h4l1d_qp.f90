module     p2_gg_httbar_d32h4l1d_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p2_gg_httbar/helicity4d32h4l1d_qp.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p2_gg_httbar_abbrevd32h4_qp
      implicit none
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(35) :: acd32
      complex(ki) :: brack
      acd32(1)=dotproduct(qshift,spvae1k2)
      acd32(2)=dotproduct(qshift,spval3e1)
      acd32(3)=abb32(33)
      acd32(4)=dotproduct(qshift,spval4e1)
      acd32(5)=abb32(11)
      acd32(6)=dotproduct(qshift,spval5e1)
      acd32(7)=abb32(19)
      acd32(8)=dotproduct(qshift,spvae2e1)
      acd32(9)=abb32(20)
      acd32(10)=abb32(10)
      acd32(11)=dotproduct(qshift,spvae1l4)
      acd32(12)=abb32(21)
      acd32(13)=dotproduct(qshift,spvae1e2)
      acd32(14)=abb32(24)
      acd32(15)=abb32(17)
      acd32(16)=dotproduct(qshift,spvae1l3)
      acd32(17)=abb32(46)
      acd32(18)=abb32(31)
      acd32(19)=abb32(28)
      acd32(20)=abb32(26)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd32(9)=abb32(20)
      acd32(10)=abb32(10)
      acd32(11)=spval3e1(iv1)
      acd32(12)=dotproduct(qshift,spvae1k2)
      acd32(13)=dotproduct(qshift,spvae1l4)
      acd32(14)=abb32(21)
      acd32(15)=dotproduct(qshift,spvae1e2)
      acd32(16)=abb32(24)
      acd32(17)=abb32(17)
      acd32(18)=spval4e1(iv1)
      acd32(19)=dotproduct(qshift,spvae1l3)
      acd32(20)=abb32(46)
      acd32(21)=abb32(31)
      acd32(22)=spval5e1(iv1)
      acd32(23)=abb32(28)
      acd32(24)=abb32(26)
      acd32(25)=abb32(18)
      acd32(26)=spvae2e1(iv1)
      acd32(27)=abb32(48)
      acd32(28)=abb32(14)
      acd32(29)=spvae1l4(iv1)
      acd32(30)=abb32(27)
      acd32(31)=spvae1e2(iv1)
      acd32(32)=abb32(15)
      acd32(33)=spvae1l3(iv1)
      acd32(34)=abb32(16)
      ...
      acd32(38)=acd32(39)-acd32(34)+acd32(38)
      acd32(38)=acd32(33)*acd32(38)
      acd32(39)=-acd32(31)*acd32(24)
      acd32(40)=acd32(29)*acd32(23)
      acd32(39)=acd32(39)+acd32(40)
      acd32(39)=acd32(6)*acd32(39)
      acd32(40)=-acd32(31)*acd32(16)
      acd32(41)=acd32(29)*acd32(14)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd32(1)=spvae1k2(iv1)
      acd32(2)=spval3e1(iv2)
      acd32(3)=abb32(33)
      acd32(4)=spval4e1(iv2)
      acd32(5)=abb32(11)
      acd32(6)=spval5e1(iv2)
      acd32(7)=abb32(19)
      acd32(8)=spvae2e1(iv2)
      acd32(9)=abb32(20)
      acd32(10)=spvae1k2(iv2)
      acd32(11)=spval3e1(iv1)
      acd32(12)=spval4e1(iv1)
      acd32(13)=spval5e1(iv1)
      acd32(14)=spvae2e1(iv1)
      acd32(15)=spvae1l4(iv2)
      acd32(16)=abb32(21)
      acd32(17)=spvae1e2(iv2)
      acd32(18)=abb32(24)
      acd32(19)=spvae1l4(iv1)
      acd32(20)=spvae1e2(iv1)
      acd32(21)=spvae1l3(iv2)
      acd32(22)=abb32(46)
      acd32(23)=spvae1l3(iv1)
      acd32(24)=abb32(28)
      acd32(25)=abb32(26)
      acd32(26)=abb32(48)
...
!---#] function derivative:
end module     p2_gg_httbar_d32h4l1d_qp

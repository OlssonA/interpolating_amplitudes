module     p2_gg_httbar_dipoles
   use p2_gg_httbar_config, only: ki
   use p2_gg_httbar_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T4, &
       & T1T5, &
       ...
       & T2T5, &
       & T4T5
   use p2_gg_httbar_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p2_gg_httbar_dipoles

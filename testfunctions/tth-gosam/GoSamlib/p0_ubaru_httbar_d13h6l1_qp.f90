module     p0_ubaru_httbar_d13h6l1_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity6d13h6l1_qp.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc13(13)=Qspval5k1*acc13(8)
      acc13(14)=Qspval3k1*acc13(10)
      acc13(15)=Qspvak2l4*acc13(7)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_ubaru_httbar_d13h6l1_qp_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_ubaru_httbar_d13h6l1_qp

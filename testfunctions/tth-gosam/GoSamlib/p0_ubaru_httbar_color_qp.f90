module     p0_ubaru_httbar_color_qp
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSam_POWHEG/Virtual/p0_ubaru_httbar/common/color.f90 
   ! generator: buildcolor.py
   use p0_ubaru_httbar_config, only: ki => ki_qp
   use p0_ubaru_httbar_model_qp, only: NC, Nf
   implicit none
   private
   save
...
contains
   subroutine     init_color()
      implicit none
      NA=NC*NC-1.0_ki
      incolors=1.0_ki*NC*NC
      cabb(1)=NC**2
      cabb(2)=cabb(1)-1.0_ki
      cabb(2)=cabb(2)*TR
      cabb(3)=NC*cabb(2)
      T1T1(1,1)=cabb(3)
      T1T1(1,2)=cabb(2)
...
end module p0_ubaru_httbar_color_qp

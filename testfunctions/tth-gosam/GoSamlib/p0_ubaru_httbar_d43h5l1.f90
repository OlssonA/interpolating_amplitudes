module     p0_ubaru_httbar_d43h5l1
   ! file: /itp/swift/jannisl/fast/POWHEG-BOX-V2/ttH_for_samplecpp_updated/GoSa &
   ! &m_POWHEG/Virtual/p0_ubaru_httbar/helicity5d43h5l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc43(18)=Qspval5k2*acc43(1)
      acc43(19)=Qspvak1l4*acc43(8)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_ubaru_httbar_d43h5l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p0_ubaru_httbar_d43h5l1

module     p0_ubaru_httbar_abbrevd13h10_qp
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb13(16)=spal3l4*spbl3k1
      abb13(17)=spak1k2*spbl5k1
      abb13(18)=abb13(17)*abb13(16)
      abb13(19)=spbl5l3*spak2l3
      abb13(20)=-abb13(19)*spbk2k1*spak2l4
      ...
      abb13(22)=-4.0_ki*spbl5l3*abb13(19)
      ...
      abb13(15)=-spbl5k2*abb13(15)*abb13(19)
...
end module p0_ubaru_httbar_abbrevd13h10_qp

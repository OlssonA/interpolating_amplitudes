module     p0_gg_gh_kinematics_qp
   use p0_gg_gh_config, only: ki => ki_qp
   use p0_gg_gh_model_qp
   use p0_gg_gh_scalar_cache
   implicit none
   save
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2, hel3)
      use p0_gg_gh_model_qp
      implicit none
      real(ki), dimension(num_legs,4), intent(in) :: vecs
      integer, intent(in), optional :: hel1
      integer, intent(in), optional :: hel2
      integer, intent(in), optional :: hel3
      complex(ki) :: N1
      logical :: flag1
      complex(ki) :: N2
      logical :: flag2
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p0_gg_gh_kinematics_qp

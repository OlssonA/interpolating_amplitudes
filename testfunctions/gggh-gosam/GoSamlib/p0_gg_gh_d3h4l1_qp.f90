...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc3(8)=abb3(15)
      acc3(9)=abb3(16)
      acc3(10)=Qspvak3k2*acc3(3)
      acc3(11)=Qspvak1k2*acc3(1)
      acc3(10)=acc3(11)+acc3(10)
      acc3(10)=Qspvak2k3*acc3(10)
      acc3(11)=Qspval4k3*acc3(5)
      acc3(12)=Qspvak2l4*acc3(2)
      acc3(13)=Qspvak1k3*acc3(4)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p0_gg_gh_d3h4l1_qp_ninja")

...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb3(5)=spak2k3**(-1)
      abb3(6)=c1-c2
      abb3(7)=i_*spbk3k1*e*gHT*abb3(3)*abb3(1)
...
end module p0_gg_gh_abbrevd3h3_qp

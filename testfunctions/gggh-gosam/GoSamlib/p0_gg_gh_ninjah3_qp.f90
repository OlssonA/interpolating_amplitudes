...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p0_gg_gh_d11h3l1_qp, only: numerator_diagram11 => numerator_ninja
   use p0_gg_gh_d11h3l121_qp, only: numerator_tmu_diagram11 => numerator_tmu
   use p0_gg_gh_d11h3l131_qp, only: numerator_t3_diagram11 => numerator_t3
   use p0_gg_gh_d11h3l132_qp, only: numerator_t2_diagram11 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p0_gg_gh_kinematics_qp
   use p0_gg_gh_model_qp
   use p0_gg_gh_d5h3l1_qp, only: numerator_diagram5 => numerator_ninja
   use p0_gg_gh_d5h3l121_qp, only: numerator_tmu_diagram5 => numerator_tmu
   use p0_gg_gh_d5h3l131_qp, only: numerator_t3_diagram5 => numerator_t3
   use p0_gg_gh_d5h3l132_qp, only: numerator_t2_diagram5 => numerator_t2
   use p0_gg_gh_d9h3l1_qp, only: numerator_diagram9 => numerator_ninja
   use p0_gg_gh_d9h3l121_qp, only: numerator_tmu_diagram9 => numerator_tmu
   use p0_gg_gh_d9h3l131_qp, only: numerator_t3_diagram9 => numerator_t3
   use p0_gg_gh_d9h3l132_qp, only: numerator_t2_diagram9 => numerator_t2
   use p0_gg_gh_globalsl1_qp, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p0_gg_gh_kinematics_qp
   use p0_gg_gh_model_qp
   use p0_gg_gh_d1h3l1_qp, only: numerator_diagram1 => numerator_ninja
   use p0_gg_gh_d1h3l121_qp, only: numerator_tmu_diagram1 => numerator_tmu
   use p0_gg_gh_d1h3l131_qp, only: numerator_t3_diagram1 => numerator_t3
   use p0_gg_gh_d1h3l132_qp, only: numerator_t2_diagram1 => numerator_t2
   use p0_gg_gh_d3h3l1_qp, only: numerator_diagram3 => numerator_ninja
   use p0_gg_gh_d3h3l121_qp, only: numerator_tmu_diagram3 => numerator_tmu
   use p0_gg_gh_d3h3l131_qp, only: numerator_t3_diagram3 => numerator_t3
   use p0_gg_gh_d3h3l132_qp, only: numerator_t2_diagram3 => numerator_t2
   use p0_gg_gh_d7h3l1_qp, only: numerator_diagram7 => numerator_ninja
   use p0_gg_gh_d7h3l121_qp, only: numerator_tmu_diagram7 => numerator_tmu
   use p0_gg_gh_d7h3l131_qp, only: numerator_t3_diagram7 => numerator_t3
   use p0_gg_gh_d7h3l132_qp, only: numerator_t2_diagram7 => numerator_t2
   use p0_gg_gh_globalsl1_qp, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p0_gg_gh_ninjah3_qp

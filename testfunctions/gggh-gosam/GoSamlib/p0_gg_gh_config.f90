module     p0_gg_gh_config
   ...
   logical :: include_color_avg_factor = .False.
   logical :: include_helicity_avg_factor = .False.
   logical :: include_symmetry_factor = .False.
   ...
   integer :: PSP_chk_th5 = 10 ! digits required double vs double_rot OR quad vs quad_rot
   integer :: PSP_chk_th6 = 7 ! digits required double/double_rot vs quad
   ...
   integer :: PSP_chk_li5 = 10 ! digits required double vs double_rot OR quad vs quad_rot
   integer :: PSP_chk_li6 = 7 ! digits required double/double_rot vs quad

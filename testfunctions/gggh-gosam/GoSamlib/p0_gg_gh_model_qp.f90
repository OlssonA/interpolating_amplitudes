module     p0_gg_gh_model_qp
   ! Model parameters for the model: /mt/home/sjones/repos/POWHEG-BOX/ggh-gosam &
   ! &/GoSam_POWHEG/Virtual/model/model
   ...
   real(ki) :: alpha =        0.007297352537599_ki
   ...
   real(ki) :: mBMS =        0.000000000000000_ki
   ...
   complex(ki) :: sw = (       0.480832611206852_ki,        0.000000000000000_k&
   &i)
   ...
   character(len=name_length), dimension(24) :: names = (/&
      & "alpha  ", &
      & "e      ", &
      & "gauge1z", &
      & "gauge2z", &
...
!---#[ print_parameter:
   ...
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")")') "#", "sw   = ", sw
   ...
   write(unit,'(A1,1x,A11,"(",G23.16,G23.16,")"," calc.")') "#", "swf  = ", swf
...
!---#[ subroutine init_functions:
   subroutine     init_functions()
     ...
     &3383279502884197169399375105820974944592307816406286209_ki
      ...
      gWWAA=-1.0_ki
      gWWWW=sw**(-2)
      gHHHH=-3.0_ki/4.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gXXXX=-3.0_ki/4.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gHHXX=-1.0_ki/4.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gHHPP=-1.0_ki/4.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gXXPP=-1.0_ki/4.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gPPPP=-1.0_ki/2.0_ki/(mW**2-i_*mW*wW)*mH**2*sw**(-2)
      gHHH=-3.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mH**2*sw**(-1)
      gHXX=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mH**2*sw**(-1)
      gHPP=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mH**2*sw**(-1)
      ...
      gHU=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mU*sw**(-1)
      gHD=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mD*sw**(-1)
      gHC=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mC*sw**(-1)
      gHS=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mS*sw**(-1)
      gHB=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mBMS*sw**(-1)
      gHT=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mT*sw**(-1)
      gHe=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*me*sw**(-1)
      gHmu=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mmu*sw**(-1)
      gHtau=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mtau*sw**(-1)
      gXU=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mU*sw**(-1)
      gXD=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mD*sw**(-1)
      gXC=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mC*sw**(-1)
      gXS=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mS*sw**(-1)
      gXB=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mBMS*sw**(-1)
      gXT=-1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mT*sw**(-1)
      gXe=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*me*sw**(-1)
      gXmu=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mmu*sw**(-1)
      gXtau=1.0_ki/2.0_ki/(sqrt(mW**2-i_*mW*wW))*mtau*sw**(-1)
      gPU=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mU*sw**(-1)
      gPD=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mD*sw**(-1)
      gPC=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mC*sw**(-1)
      gPS=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mS*sw**(-1)
      gPB=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mBMS*sw**(-1)
      gPT=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mT*sw**(-1)
      gPe=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*me*sw**(-1)
      gPmu=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mmu*sw**(-1)
      gPtau=1.0_ki/(sqrt(mW**2-i_*mW*wW))*sqrt2**(-1)*mtau*sw**(-1)
 ...
 &3383279502884197169399375105820974944592307816406286209_ki
  ...
  select case (ichoice)
      ...
      ! alpha --> e
        e = sqrt(4.0_ki*pi*alpha)
      ! GF, mZ, alpha --> mW
      mW = sqrt((mZ*mZ-i_*mZ*wZ)/2.0_ki+sqrt((mZ*mZ-i_*mZ*wZ)**2/4.0_ki-pi*alph&
      &a*(mZ*mZ-i_*mZ*wZ)/&
     & sqrt(2.0_ki)/GF))
      ! mW, mZ --> sw
      sw = sqrt(1.0_ki-(mW*mW-i_*mW*wW)/(mZ*mZ-i_*mZ*wZ))

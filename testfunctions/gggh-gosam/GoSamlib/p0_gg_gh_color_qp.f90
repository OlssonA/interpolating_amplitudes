module     p0_gg_gh_color_qp
   ! file: /mt/home/sjones/repos/POWHEG-BOX/ggh-gosam/GoSam_POWHEG/Virtual/p0_gg_gh/common/color.f90 
   ! generator: buildcolor.py
   use p0_gg_gh_config, only: ki => ki_qp
   use p0_gg_gh_model_qp, only: NC, Nf
   implicit none
   private
   save

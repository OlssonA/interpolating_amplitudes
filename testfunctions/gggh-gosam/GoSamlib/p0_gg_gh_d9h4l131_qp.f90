...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd9(1)=dotproduct(ninjaE3,spvak3k2)
      acd9(2)=dotproduct(ninjaE3,spvak1k2)
      acd9(3)=dotproduct(ninjaE4,spvak2k3)
      acd9(4)=abb9(12)
      acd9(5)=dotproduct(ninjaE3,spvak2k3)
      acd9(6)=dotproduct(ninjaE4,spvak1k2)
      acd9(7)=abb9(5)
      acd9(8)=dotproduct(ninjaE4,spvak3k2)
      acd9(9)=abb9(9)
      acd9(10)=dotproduct(k2,ninjaE3)
      acd9(11)=dotproduct(k3,ninjaE3)
      acd9(12)=abb9(15)
      acd9(13)=dotproduct(ninjaE3,spvak1k3)
      acd9(14)=abb9(6)
      acd9(15)=abb9(18)
      acd9(16)=dotproduct(ninjaE3,spval4k2)
      acd9(17)=abb9(21)
      acd9(18)=dotproduct(ninjaA,ninjaE3)
      acd9(19)=dotproduct(ninjaA,spvak3k2)
      acd9(20)=dotproduct(ninjaA,spvak1k2)
      acd9(21)=dotproduct(ninjaA,spvak2k3)
      acd9(22)=abb9(10)
      acd9(23)=dotproduct(k2,ninjaA)
      acd9(24)=dotproduct(k3,ninjaA)
      acd9(25)=dotproduct(ninjaA,spvak1k3)
      acd9(26)=abb9(14)
      acd9(27)=dotproduct(ninjaA,spval4k2)
      acd9(28)=abb9(11)
      ...
      acd9(48)=acd9(31)*acd9(13)
      acd9(49)=acd9(32)*acd9(2)
      acd9(50)=acd9(33)*acd9(16)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p0_gg_gh_d9h4_qp_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p0_gg_gh_d9h4l131_qp
